    ...
    public class MetadataStore : IProvideAttributeTable
    {
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                // HubTile
                attributeTableBuilder.AddTable(new HubTileMetadata().CreateTable());

                // MultiselectItem
                attributeTableBuilder.AddTable(new MultiselectItemMetadata().CreateTable());

                // MultiselectList
                attributeTableBuilder.AddTable(new MultiselectListMetadata().CreateTable());

                // ExpanderView
                attributeTableBuilder.AddTable(new ExpanderViewMetadata().CreateTable());
