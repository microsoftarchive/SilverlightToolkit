...
[assembly: SuppressMessage("Compatibility", "SWC4000:GeneralWPFCompatibilityRule", MessageId = "Viewbox, base is System.Windows.Controls.ContentControl (Silverlight) vs System.Windows.Controls.Decorator (wpf)", Justification = "Silverlight for Windows Phone 7 does not support direct manipulation of the visual tree, so Viewbox has to inherit from a core control that can.")]
    ...
    public sealed partial class Viewbox : ContentControl
    {
        ...
        private static void OnStretchPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!IsValidStretchValue(e.NewValue))
            {
                ...
                // throw exception
                throw new ArgumentException("Stretch");
            }
