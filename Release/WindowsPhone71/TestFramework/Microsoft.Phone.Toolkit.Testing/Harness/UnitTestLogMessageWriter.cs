...
namespace Microsoft.Phone.Testing.Harness
{
  ...
  public class UnitTestLogMessageWriter : LogMessageWriter
  {
    ...
    {
      string message = String.Format(CultureInfo.CurrentCulture, Properties.UnitTestMessage.LogIgnore, name);
    ...
    {
      string message = granularity.ToString() + assembly.Name + " " + stage.ToString().ToLower(CultureInfo.InvariantCulture);
