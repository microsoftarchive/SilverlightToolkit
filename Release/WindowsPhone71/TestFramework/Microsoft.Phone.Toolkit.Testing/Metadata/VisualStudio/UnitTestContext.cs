...
namespace Microsoft.Phone.Testing.Metadata.VisualStudio
{
  /// <summary>
  ...
  public class UnitTestContext : VS.TestContext
  {
    ...
    {
      return new NotSupportedException(String.Format(CultureInfo.InvariantCulture, Microsoft.Phone.Testing.Properties.UnitTestMessage.UnitTestContext_FeatureNotSupported, functionality));
    }
