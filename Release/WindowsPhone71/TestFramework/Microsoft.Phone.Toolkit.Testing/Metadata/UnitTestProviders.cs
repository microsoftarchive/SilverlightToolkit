...
namespace Microsoft.Phone.Testing.Metadata
{
  ...
  public static class UnitTestProviders
  {
    ...
    static UnitTestProviders()
    {
      ...
      _providers.Add(new Microsoft.Phone.Testing.Metadata.VisualStudio.VsttProvider());
    ...
    public static IAssembly GetAssemblyWrapper(UnitTestHarness harness, Assembly testAssembly)
    {
