...
namespace Microsoft.VisualStudio.TestTools.UnitTesting
{
  ...
  public static class Test
  {
    ...
    [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "Signature is required by C# compiler to enable expressions.")]
    public static void Assert(Expression<Func<bool>> predicate, string message)
    {
    ...
    private static string GetMessageExpression(Expression expression, string message)
    {
      if (message != null)
      {
        return message;
    ...
    private static Action CreateAssertExpressionAction(Expression expression, string message)
    {
