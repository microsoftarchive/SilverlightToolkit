...
namespace Microsoft.Phone.Testing.Client
{
  ...
  public class TestMethodData : PropertyChangedBase, IProvideResultReports
  {
    ...
    public string SimplifiedExceptionStackTrace
    {
      get
      {
        if (_result != null && _result.Exception != null && _result.Exception.StackTrace != null)
        {
          ...
          int i = st.IndexOf("   at Microsoft.Phone.Testing.Harness.CompositeWorkItem.Invoke(WorkItem& usedWorkItem)");
          if (i >= 0)
          {
    ...
    /// </summary>
    public string SimplifiedInnerExceptionName
    {
      get
      {
        if (_result != null && _result.Exception != null && _result.Exception.InnerException != null)
        {
          Type t = _result.Exception.InnerException.GetType();
          return t.Name;
        }
        return null;
      }
