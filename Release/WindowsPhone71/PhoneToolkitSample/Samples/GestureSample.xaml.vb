...
Namespace Samples
    ...
    Partial Public Class GestureSample
        ...
        Private Sub OnTap(ByVal sender As Object, ByVal e As System.Windows.Input.GestureEventArgs)
            transform.TranslateY = 0
            transform.TranslateX = transform.TranslateY
        End Sub

        Private Sub OnDoubleTap(ByVal sender As Object, ByVal e As System.Windows.Input.GestureEventArgs)
            transform.ScaleY = 1
            transform.ScaleX = transform.ScaleY
        End Sub

        Private Sub OnHold(ByVal sender As Object, ByVal e As System.Windows.Input.GestureEventArgs)
            transform.TranslateY = 0
            transform.TranslateX = transform.TranslateY
            transform.ScaleY = 1
            transform.ScaleX = transform.ScaleY
