...
Namespace Data
    ...
    Public Class LoremIpsumWebsites
        Implements Collections.Generic.IEnumerable(Of Tuple(Of String, String))

        ''' <summary>
        ''' Enumerates the Words property.
        ''' </summary>
        ''' <returns>The enumerator.</returns>
        Public Function GetEnumerator() As Collections.Generic.IEnumerator(Of Tuple(Of String, String)) Implements Collections.Generic.IEnumerable(Of Tuple(Of String, String)).GetEnumerator
