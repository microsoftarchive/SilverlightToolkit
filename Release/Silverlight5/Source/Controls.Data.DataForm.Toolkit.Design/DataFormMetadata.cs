            ...
            AddCallback(
                typeof(SSWC.DataForm), b =>
                {
                    ...
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.CurrentIndex),
                        new DataContextValueSourceAttribute(itemsSourceName, true));
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.CurrentItem),
                        new DataContextValueSourceAttribute(itemsSourceName, true));
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.ReadOnlyTemplate), 
                        new DataContextValueSourceAttribute(itemsSourceName, true));
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.HeaderTemplate),
                        new DataContextValueSourceAttribute(
                            Extensions.GetMemberName<SSWC.DataForm>(x => x.Template),
                            true));
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.EditTemplate),
                        new DataContextValueSourceAttribute(
                            Extensions.GetMemberName<SSWC.DataForm>(x => x.CurrentItem),
                            false));
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.DataForm>(x => x.NewItemTemplate),
                        new DataContextValueSourceAttribute(
                            Extensions.GetMemberName<SSWC.DataForm>(x => x.CurrentItem),
                            false));
#endif
