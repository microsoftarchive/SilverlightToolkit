...
namespace System.Windows
{
    ...
    public static class UIElementExtendedRoutedEventExtensions
    {
        ...
        private static List<SW.ExtendedRoutedEvent> targetEvents =
            new List<Microsoft.Windows.ExtendedRoutedEvent>
                {
        ...
        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters", Justification = "WPF Compat method that exists on UIElement.")]
        ...
        /// <param name="routedEvent">An identifier for the routed event to be handled.</param>
        /// <param name="handler">A reference to the handler implementation.</param>
        [SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters", Justification = "Attached property only applied to UIElement.")]
