...
namespace Microsoft.Windows
{
    ...
    public static class DragDrop
    {
        ...
        internal static IObservable<IEvent<DragDropCompletedEventArgs>> GetDragCompleted()
        {
            return new AnonymousObservable<IEvent<DragDropCompletedEventArgs>>(
                observer =>
                {
                    EventHandler<DragDropCompletedEventArgs> handler = (_, args) => observer.OnNext(Event.Create(null, args));
