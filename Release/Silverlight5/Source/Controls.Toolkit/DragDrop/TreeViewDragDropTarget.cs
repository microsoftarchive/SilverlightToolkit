...
namespace System.Windows.Controls
{
    ...
    public class TreeViewDragDropTarget : ItemsControlDragDropTarget<ItemsControl, TreeViewItem>
    {
        ...
        /// </summary>
        private ISubject<IEvent<SW.DragEventArgs>> _dragEnter = new Subject<IEvent<SW.DragEventArgs>>();

        /// <summary>
        /// An event raised when a drag leave operation occurs.
        /// </summary>
        private ISubject<IEvent<SW.DragEventArgs>> _dragLeave = new Subject<IEvent<SW.DragEventArgs>>();

        /// <summary>
        /// An event raised when a drop operation occurs.
        /// </summary>
        private ISubject<IEvent<SW.DragEventArgs>> _drop = new Subject<IEvent<SW.DragEventArgs>>();
        ...
        protected override void OnDragEnter(SW.DragEventArgs args)
        {
            ...
            _dragEnter.OnNext(Event.Create(this, args));
        }
        ...
        protected override void OnDrop(SW.DragEventArgs args)
        {
            ...
            _drop.OnNext(Event.Create(this, args));
        }
