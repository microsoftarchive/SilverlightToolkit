...
namespace Microsoft.Silverlight.Testing.Harness
{
    ...
    public partial class VisualStudioLogProvider : LogProvider
    {
        ...
        private class Writer
        {
            ...
            /// </summary>
            protected SimpleXElement TestRun { get; private set; }
            ...
            /// </summary>
            protected SimpleXElement TestRunConfiguration { get; private set; }

            /// <summary>
            /// Gets the Counters element.
            /// </summary>
            protected SimpleXElement Counters { get; private set; }

            /// <summary>
            /// Gets the TestDefinitions element.
            /// </summary>
            protected SimpleXElement TestDefinitions { get; private set; }

            /// <summary>
            /// Gets the TestLists element.
            /// </summary>
            protected SimpleXElement TestLists { get; private set; }

            /// <summary>
            /// Gets the TestEntries element.
            /// </summary>
            protected SimpleXElement TestEntries { get; private set; }

            /// <summary>
            /// Gets the Times element.
            /// </summary>
            protected SimpleXElement Times { get; private set; }

            /// <summary>
            /// Gets the ResultSummary element.
            /// </summary>
            protected SimpleXElement ResultSummary { get; private set; }

            /// <summary>
            /// Gets the Results element.
            /// </summary>
            protected SimpleXElement Results { get; private set; }
            ...
            /// </summary>
            private List<SimpleXElement> _pendingElements;
            ...
            public Writer()
            {
                _pendingElements = new List<SimpleXElement>();
            ...
            private SimpleXElement CreateElement(string name)
            {
                return new SimpleXElement(name, ResultsXmlNamespace);
            }
            ...
            public string TestRunConfigurationDescription
            {
                set
                {
                    TestRunConfiguration.SetElementValue("Description", value, ResultsXmlNamespace);
                }
            }
