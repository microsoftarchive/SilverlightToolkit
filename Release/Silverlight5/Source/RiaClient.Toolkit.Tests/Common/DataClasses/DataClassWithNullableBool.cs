...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    public class DataClassWithNullableBool : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private DataClassWithNullableBool oldDataClass;

        /// <summary>
        /// The unchaged data class for use in IRevertibleChangeTracking.
        /// </summary>
        private DataClassWithNullableBool unchangedDataClass;
        ...
        /// </summary>
        [DataMember()]
        [Display(AutoGenerateField = true, Name = "Bool Property")]
        ...
        private void EnsureUnchangedDataClass()
        {
            ...
            {
                this.unchangedDataClass = new DataClassWithNullableBool();
        ...
        public void BeginEdit()
        {
            ...
            {
                this.oldDataClass = new DataClassWithNullableBool();
