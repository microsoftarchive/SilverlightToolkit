...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    [ReadOnly(true)]
    public class ReadOnlyDataClass : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private ReadOnlyDataClass oldDataClass;
        ...
        /// </summary>
        private ReadOnlyDataClass unchangedDataClass;
        ...
        private void EnsureUnchangedDataClass()
        {
            ...
            {
                this.unchangedDataClass = new ReadOnlyDataClass();
        ...
        public void BeginEdit()
        {
            ...
            {
                this.oldDataClass = new ReadOnlyDataClass();
