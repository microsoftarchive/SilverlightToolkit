...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DataClassWithUneditableType : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        ...
        /// <summary>
        /// Private accessor to UneditableTypeProperty.
        /// </summary>
        private UneditableType uneditableTypeProperty;
        ...
        /// <summary>
        /// Gets or sets an uneditable type.
        /// </summary>
        [DataMember()]
        [Display(AutoGenerateField = true, Description = "Uneditable Type Property Description", Name = "Uneditable Type Property")]
        public UneditableType UneditableTypeProperty
        {
            get
            {
                return this.uneditableTypeProperty;
            }

            set
            {
                if ((this.uneditableTypeProperty != value))
                {
                    this.EnsureUnchangedDataClass();
                    this.ValidateProperty("UneditableTypeProperty", value);
                    this.uneditableTypeProperty = value;
                    this.RaiseDataMemberChanged("UneditableTypeProperty");
                }
            }
        }
