...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    public class DataClassWithMissingDescriptions : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private DataClassWithMissingDescriptions oldDataClass;
        ...
        /// </summary>
        private DataClassWithMissingDescriptions unchangedDataClass;
        ...
        private void EnsureUnchangedDataClass()
        {
            ...
            {
                this.unchangedDataClass = new DataClassWithMissingDescriptions();
        ...
        public void BeginEdit()
        {
            ...
            {
                this.oldDataClass = new DataClassWithMissingDescriptions();
