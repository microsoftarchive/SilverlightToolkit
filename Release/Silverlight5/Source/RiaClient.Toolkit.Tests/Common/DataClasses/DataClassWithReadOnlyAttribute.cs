...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    public class DataClassWithReadOnlyAttribute : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private DataClassWithReadOnlyAttribute oldDataClass;
        ...
        /// </summary>
        private DataClassWithReadOnlyAttribute unchangedDataClass;
        ...
        private void EnsureUnchangedDataClass()
        {
            ...
            {
                this.unchangedDataClass = new DataClassWithReadOnlyAttribute();
        ...
        public void BeginEdit()
        {
            ...
            {
                this.oldDataClass = new DataClassWithReadOnlyAttribute();
