    ...
    internal class ExpandableContentControlMetadata : AttributeTableBuilder
    {
            ...
            : base()
        {
            AddCallback(
                ...
                b =>
                {
                    b.AddCustomAttributes(new DefaultPropertyAttribute(Extensions.GetMemberName<SSWCP.ExpandableContentControl>(x => x.Percentage)));
                    b.AddCustomAttributes(new DefaultEventAttribute("ContentSizeChanged"));
                });
        }
    }
}
