            ...
            : base()
        {
            AddCallback(
                ...
                b =>
                {
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.IsReadOnly), new CategoryAttribute(Properties.Resources.CommonProperties));
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.IsValid), new CategoryAttribute(Properties.Resources.CommonProperties));
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.Mode), new CategoryAttribute(Properties.Resources.CommonProperties));
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.PropertyPath), new CategoryAttribute(Properties.Resources.CommonProperties));
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.DescriptionViewerVisibility), new CategoryAttribute(Properties.Resources.Layout));
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.DescriptionViewerVisibility), new EditorBrowsableAttribute(EditorBrowsableState.Advanced));
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.LabelVisibility), new CategoryAttribute(Properties.Resources.Layout));
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.LabelVisibility), new EditorBrowsableAttribute(EditorBrowsableState.Advanced));

                    // TextBoxEditor
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataField>(x => x.Label), PropertyValueEditor.CreateEditorAttribute(typeof(TextBoxEditor)));
