...
namespace CustomModelEffectPipeline
{
    ...
    public class CubemapProcessor : ContentProcessor<TextureContent, TextureCubeContent>
    {
        ...
        {
            // Chain to the TexturePlusAlpha processor, which will merge a separate alpha map
            // into our source image. This data is used by the EnvironmentMapEffect to display
            // specular highlights, when the specular amount slider is turned up.
            input = context.Convert<TextureContent, TextureContent>(input, "TexturePlusAlphaProcessor");
            ...
            cubemap.ConvertBitmapType(typeof(Dxt5BitmapContent));
