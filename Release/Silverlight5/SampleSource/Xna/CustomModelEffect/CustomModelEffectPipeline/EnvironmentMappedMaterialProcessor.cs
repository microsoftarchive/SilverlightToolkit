...
namespace CustomModelEffectPipeline
{
    ...
    public class EnvironmentMappedMaterialProcessor : MaterialProcessor
    {
        ...
        {
            // Create a new environment mapped material.
            EnvironmentMapMaterialContent envmapMaterial = new EnvironmentMapMaterialContent();
            ...
            {
                envmapMaterial.Texture = basicMaterial.Texture;
            }

            // Add the reflection texture.
            string envmap = Path.GetFullPath(EnvironmentMap);

            envmapMaterial.EnvironmentMap = new ExternalReference<TextureContent>(envmap);

            // Chain to the base material processor.
            return base.Process(envmapMaterial, context);
        }
