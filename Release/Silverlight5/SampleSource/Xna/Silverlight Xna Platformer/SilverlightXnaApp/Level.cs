    ...
    class Level : IDisposable
    {
        ...
        public void Update(DrawEventArgs drawEventArgs)
        {
            ...
            else if (ReachedExit)
            {
                ...
                int seconds = (int)Math.Round(drawEventArgs.DeltaTime.TotalSeconds * 100.0f);
            ...
            {
                timeRemaining -= drawEventArgs.DeltaTime;

                Player.Update(drawEventArgs);

                UpdateGems(drawEventArgs);

                // Falling off the bottom of the level kills the player.
                if (Player.BoundingRectangle.Top >= Height * Tile.Height)
                    OnPlayerKilled(null);

                UpdateEnemies(drawEventArgs);
        ...
        /// </summary>
        private void UpdateGems(DrawEventArgs drawEventArgs)
        {
            for (int i = 0; i < gems.Count; ++i)
            {
                Gem gem = gems[i];

                gem.Update(drawEventArgs);
        ...
        /// </summary>
        private void UpdateEnemies(DrawEventArgs drawEventArgs)
        {
            foreach (Enemy enemy in enemies)
            {
                enemy.Update(drawEventArgs);
        ...
        public void Draw(DrawEventArgs drawEventArgs, SpriteBatch spriteBatch)
        {
            ...
            foreach (Gem gem in gems)
                gem.Draw(drawEventArgs, spriteBatch);

            Player.Draw(drawEventArgs, spriteBatch);

            foreach (Enemy enemy in enemies)
                enemy.Draw(drawEventArgs, spriteBatch);
