...
namespace SilverlightXnaApp
{
    ...
    class Gem
    {
        ...
        public readonly Color Color = new Color(1.0f, 1.0f, 0);
        ...
        public void Update(DrawEventArgs drawEventArgs)
        {
            ...
            double t = drawEventArgs.TotalTime.TotalSeconds * BounceRate + Position.X * BounceSync;
        ...
        {
            ThreadPool.QueueUserWorkItem(state => collectedSound.Play(), null);
        }
