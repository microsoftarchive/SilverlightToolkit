...
namespace System.Windows.Controls.Samples.SyntaxHighlighting
{
    ...
    internal class CodeColorizer : ICodeColorizer
    {
        ...
        /// Initializes a new instance of the <see cref="CodeColorizer"/> class.
        /// </summary>
        /// <param name="languageParser">The language parser that the 
        /// <see cref="CodeColorizer"/> instance will use for its lifetime.</param>
        ...
        /// <summary>
        /// Colorizes source code using the specified language, the default 
        /// formatter, and the default style sheet.
        /// </summary>
