    ...
    public partial class AutoCompleteBoxTest : ControlTest
    {
        ...
        public AutoCompleteBoxTest()
        {
            ...
            TextBoxStyleProperty = new DependencyPropertyTest<AutoCompleteBox, Style>(this, "TextBoxStyle")
            {
                ...
                Initializer = initializer,
                DefaultValue = null,
                OtherValues = new Style[] { } // Silverlight 2 Styles are set-once, so don't provide other values
            };
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(IsDropDownOpenProperty.CanBeStyledTest);
            ...
            // tests.Add(MaxDropDownHeightProperty.SetXamlAttributeTest.Bug("XAML parse issue with Infinity"));
            // tests.Add(MaxDropDownHeightProperty.SetXamlElementTest.Bug("XAML parse issue with Infinity"));
            ...
            tests.Add(TextBoxStyleProperty.CanBeStyledTest.Bug("Silverlight 2 Styles are set-once"));
            ...
            tests.Add(TextBoxStyleProperty.ClearValueResetsDefaultTest.Bug("Silverlight 2 Styles are set-once"));
