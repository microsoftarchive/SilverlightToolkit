...
namespace System.Windows.Controls.Testing
{
    ...
    public class RangeTimePickerPopupTest : TimePickerPopupBaseTest
    {
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(SliderStyleProperty.ChangeClrSetterTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(SliderStyleProperty.ChangeSetValueTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(SliderStyleProperty.SetNullTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(SliderStyleProperty.ClearValueResetsDefaultTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(SliderStyleProperty.CanBeStyledTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(SliderStyleProperty.TemplateBindTest.Bug("Style with templatebinding throws catastrophic error"));
