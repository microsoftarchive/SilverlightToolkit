...
namespace System.Windows.Controls.Testing
{
    ...
    public class RatingAutomationPeerTest : TestBase
    {
        ...
        {
            Rating view = new Rating { ItemsSource = new[] { 1, 2, 3 } };
            RatingAutomationPeer peer = null;
        ...
        /// <summary>
        /// Verify that RatingAutomationPeer only supports selection and range value.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Verify that RatingAutomationPeer only supports selection and range value.")]
        public virtual void RatingPeerOnlySupportsSelectionAndRangeValue()
        {
            ...
            TestAsync(
                ...
                () => Assert.IsNotNull(peer.GetPattern(PatternInterface.RangeValue), "RatingAutomationPeer should not support the RangeValue pattern!"),
                ...
                () => Assert.IsNull(peer.GetPattern(PatternInterface.Value), "RatingAutomationPeer should not support the Value pattern!"),
