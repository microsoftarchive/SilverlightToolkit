...
namespace System.Windows.Controls.Testing
{
    ...
    public class AccordionItemTest : HeaderedContentControlTest
    {
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(AccordionButtonStyleProperty.ChangeClrSetterTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(AccordionButtonStyleProperty.ChangeSetValueTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(AccordionButtonStyleProperty.SetNullTest);
            tests.Add(AccordionButtonStyleProperty.ClearValueResetsDefaultTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(AccordionButtonStyleProperty.CanBeStyledTest);
            tests.Add(AccordionButtonStyleProperty.TemplateBindTest.Bug("bug in SL2, is fixed in SL3"));
            ...
            tests.Add(ExpandableContentControlStyleProperty.ChangeClrSetterTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(ExpandableContentControlStyleProperty.ChangeSetValueTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(ExpandableContentControlStyleProperty.SetNullTest);
            tests.Add(ExpandableContentControlStyleProperty.ClearValueResetsDefaultTest.Bug("bug in SL2, is fixed in SL3"));
            tests.Add(ExpandableContentControlStyleProperty.CanBeStyledTest);
            tests.Add(ExpandableContentControlStyleProperty.TemplateBindTest.Bug("bug in SL2, is fixed in SL3"));
