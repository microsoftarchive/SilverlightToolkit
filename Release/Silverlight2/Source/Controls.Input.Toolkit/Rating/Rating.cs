...
namespace System.Windows.Controls
{
    ...
    public class Rating : ItemsControl, IUpdateVisualState
    {
        ...
        /// <summary>
        /// Gets or sets the internal InternalItemContainerGenerator.
        /// </summary>
        private LightweightItemContainerGenerator InternalItemContainerGenerator { get; set; }

        /// <summary>
        /// Gets the item container generator.
        /// </summary>
        public IItemContainerGenerator ItemContainerGenerator { get { return InternalItemContainerGenerator; } }
        ...
        {
            InternalItemContainerGenerator.UpdateItemContainerStyle(newValue);
        }
        ...
        public Rating()
        {
            ...
            InternalItemContainerGenerator = new LightweightItemContainerGenerator(this);
        }
        ...
        {
            InternalItemContainerGenerator.OnApplyTemplate();
        ...
        protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
        {
            ...
            InternalItemContainerGenerator.PrepareContainerForItemOverride(element, item, this.ItemContainerStyle);
        ...
        {
            RatingItem ratingItem = (RatingItem)element;
            InternalItemContainerGenerator.ClearContainerForItemOverride(element, item);
            ratingItem.Click -= RatingItemClick;
            ratingItem.MouseEnter -= RatingItemMouseEnter;
            ratingItem.MouseLeave -= RatingItemMouseLeave;
        ...
        internal IEnumerable<RatingItem> GetRatingItems()
        {
            return
                Enumerable
                    ...
                    .Select(index => (RatingItem)InternalItemContainerGenerator.ContainerFromIndex(index))
