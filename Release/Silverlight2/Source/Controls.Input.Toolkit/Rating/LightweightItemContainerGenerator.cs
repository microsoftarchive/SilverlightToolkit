...
{
    /// <summary>
    /// The LightWeightItemContainerGenerator provides useful utilities for 
    /// mapping between the items of an ItemsControl and their generated 
    /// containers.
    /// </summary>
    /// <remarks>
    /// WPF actually uses the LightWeightItemContainerGenerator to create all of
    /// the containers used by an ItemsControl.  The container generation in
    /// Silverlight happens in the native implementation of ItemsControl, so
    /// this ItemContainerGenerator2 serves only to expose the mapping between
    /// items and containers in a subset of the WPF API.
    /// </remarks>
    /// <QualityBand>Preview</QualityBand>
    internal sealed partial class LightweightItemContainerGenerator : IItemContainerGenerator
    {
        /// <summary>
        /// Gets or sets the ItemsControl being tracked by the
        /// ItemContainerGenerator2.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the ItemContainerGenerator2.
        /// </summary>
        /// <param name="control">
        /// The ItemsControl being tracked by the ItemContainerGenerator2.
        /// </param>
        internal LightweightItemContainerGenerator(ItemsControl control)
        {
        ...
        internal void PrepareContainerForItemOverride(DependencyObject element, object item, Style parentItemContainerStyle)
        {
            ...
            // ItemContainerGenerator2, we've removed that code for now.  It
