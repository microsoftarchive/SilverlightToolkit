            ...
            AddCallback(
                ...
                b =>
                {
                    ...
                    b.AddCustomAttributes(
                        Extensions.GetMemberName<SSWC.RatingItem>(x => x.Content),
                        new AlternateContentPropertyAttribute());

                    b.AddCustomAttributes(new ToolboxCategoryAttribute(ToolboxCategoryPaths.BasicControls, false));

                    b.AddCustomAttributes(new FeatureAttribute(typeof(RatingItemIsSelectedDesignModeValueProvider)));
                    b.AddCustomAttributes(new FeatureAttribute(typeof(RatingItemIsSelectedDesignModeValueProvider.AdornerProxy)));
#endif
                });
        }
    }
