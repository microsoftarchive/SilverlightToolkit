            ...
            : base()
        {
            AddCallback(
                ...
                b =>
                {
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWCP.LinearClipper>(x => x.RatioVisible), new Attribute[] { new NumberRangesAttribute(null, 0.0, 1.0, null, null) });
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWCP.LinearClipper>(x => x.RatioVisible), new Attribute[] { new NumberIncrementsAttribute(null, 0.0005, null) });
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWCP.LinearClipper>(x => x.RatioVisible), new Attribute[] { new NumberFormatAttribute("0'%", 3, 100.0) });
#endif
                });
        }
    }
