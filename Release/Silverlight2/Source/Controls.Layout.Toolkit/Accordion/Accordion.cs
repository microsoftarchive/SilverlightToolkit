...
namespace System.Windows.Controls
{
    ...
    public class Accordion : ItemsControl, IUpdateVisualState
    {
        ...
        /// </summary>
        private readonly AccordionItemContainerGenerator _itemContainerGenerator;
        ...
        private void UnselectItem(int index, object item)
        {
            ...
            AccordionItem container = ItemContainerGenerator.ContainerFromIndex(index) as AccordionItem;
        ...
        {
            AccordionItem oldAccordionItem = ItemContainerGenerator.ContainerFromIndex(oldIndex) as AccordionItem;
            AccordionItem newAccordionItem = ItemContainerGenerator.ContainerFromIndex(newIndex) as AccordionItem;
        ...
        private void LayoutChildren()
        {
            ...
            if (root != null && _itemContainerGenerator.ItemsHost != null)
            {
                if (IsShouldFillWidth)
                {
                    ...
                    // was made smaller.
                    double smaller = root.ViewportWidth - _itemContainerGenerator.ItemsHost.ActualWidth;
                ...
                else if (IsShouldFillHeight)
                {
                    ...
                    // offset for the real difference in viewportheight and actualheight. This happens when accordion
                    // was made smaller.
                    double smaller = root.ViewportHeight - _itemContainerGenerator.ItemsHost.ActualHeight;
