...
''' </summary>
<Sample("(0)Rating", DifficultyLevel.Basic), Category("Rating")> _
Partial Public Class RatingSample
    ...
    Private Sub Netflix_ValueChanged(ByVal sender As Object, ByVal e As RoutedPropertyChangedEventArgs(Of Global.System.Nullable(Of Double)))
    ...
    ''' <param name="e">Event args.</param>
    <SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification:="Method is called in XAML.")> _
    Private Sub NetflixButton_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        netflix.Value = 0
    End Sub
End Class
