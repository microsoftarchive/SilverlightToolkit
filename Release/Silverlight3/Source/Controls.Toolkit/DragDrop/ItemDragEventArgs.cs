...
namespace System.Windows.Controls
{
    ...
    public sealed class ItemDragEventArgs<TItemsControlType> : SW.ExtendedRoutedEventArgs
        where TItemsControlType : UIElement
    {
        ...
        /// </summary>
        public TItemsControlType DragSource { get; internal set; }
        ...
        internal ItemDragEventArgs(ItemDragEventArgs<TItemsControlType> args)
        {
