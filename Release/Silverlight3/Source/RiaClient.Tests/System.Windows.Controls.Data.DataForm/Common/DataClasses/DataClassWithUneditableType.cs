...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    public class DataClassWithUneditableType : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private DataClassWithUneditableType oldDataClass;
        ...
        /// </summary>
        private DataClassWithUneditableType unchangedDataClass;

        /// <summary>
        /// Private accessor to UnknownTypeProperty.
        /// </summary>
        private UneditableType unknownTypeProperty;
        ...
        /// <summary>
        /// Gets or sets an unknown type.
        /// </summary>
        [DataMember()]
        [Display(AutoGenerateField = true, Description = "Unknown Type Property Description", Name = "Unknown Type Property")]
        public UneditableType UnknownTypeProperty
        {
            get
            {
                return this.unknownTypeProperty;
            }

            set
            {
                if ((this.unknownTypeProperty != value))
                {
                    this.EnsureUnchangedDataClass();
                    this.ValidateProperty("UnknownTypeProperty", value);
                    this.unknownTypeProperty = value;
                    this.RaiseDataMemberChanged("UnknownTypeProperty");
                }
            }
        }
        ...
        private void EnsureUnchangedDataClass()
        {
            ...
            {
                this.unchangedDataClass = new DataClassWithUneditableType();
        ...
        public void BeginEdit()
        {
            if (this.oldDataClass == null)
            {
                ...
                this.oldDataClass.unknownTypeProperty = this.unknownTypeProperty;
            }
        }
        ...
        public void CancelEdit()
        {
            if (this.oldDataClass != null)
            {
                ...
                this.UnknownTypeProperty = this.oldDataClass.unknownTypeProperty;
