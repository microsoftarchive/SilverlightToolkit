//-----------------------------------------------------------------------
// <copyright file="ObservableEnumerableCollection.cs" company="Microsoft">
...
{
    /// <summary>
    /// Collection used for unit tests that does not implement IList, but
    /// implements INotifyCollectionChanged
    /// </summary>
    public sealed class ObservableEnumerableCollection<T> : IEnumerable, INotifyCollectionChanged
        where T : new()
    {
        ...
        /// Default constructor
        /// </summary>
        public ObservableEnumerableCollection()
        {
        ...
        /// <summary>
        /// Handler for the CollectionChanged event on the underlying collection.
        /// We will re-fire this event from our collection
        /// </summary>
        /// <param name="sender">Sender for the event</param>
        /// <param name="e">NotifyCollectionChangedEventArgs for the event</param>
