        ...
        where TDataClassSource : DataClassSource<TDataClass>, new()
    {
        ...
        public virtual void InvalidEditIntegerCell()
        {
            ...
            EnqueueCallback(delegate
            {
               ...
               ((TextBox)dataGrid.CurrentColumn.GetCellContent(listTestType.First())).Text = Common.RandomString(10);
                ...
                Assert.AreEqual(1, dataGrid.TestHook.ValidationSummary.Errors.Count, "Property error should surface in the ValidationSummary");
        ...
        private void EnqueueColumnReorder(DataGrid dataGrid, bool cancel)
        {
            EnqueueCallback(delegate
            {
                ...
                GeneralTransform transformToGridParent = dataGrid.Columns[0].HeaderCell.TransformToVisual(null);
                dataGrid.Columns[0].HeaderCell.OnMouseMove(ref handled, mousePosition, transformToGridParent.Transform(mousePosition));
                ...
                handled = false;
                dataGrid.Columns[0].HeaderCell.OnMouseLeftButtonUp(ref handled, mousePosition);
        ...
        public virtual void SetColumnHeaderContent()
        {
            ...
            EnqueueCallback(delegate
            {
                ...
                Common.AssertExpectedException(
                    DataGridError.DataGridColumnHeader.ContentDoesNotSupportUIElements(),
                    () =>
                    {
                        try
                        {
