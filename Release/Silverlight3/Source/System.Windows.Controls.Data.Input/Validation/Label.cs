...
namespace System.Windows.Controls
{
    ...
    public class Label : ContentControl
    {
        ...
        public Label()
        {
            ...
            // This will set Content to be bound to ContentInternal, which is automatically generated with a string denoting the caption of the target.
            // If the Content property is explicity set, this binding will break and instead show the new content. Refresh() can be called to revert
            // back to the autogenerated value.
            Binding binding = new Binding("ContentInternal");
            binding.Source = this;
            this.SetBinding(ContentControl.ContentProperty, binding);
            if (DesignerProperties.IsInDesignTool)
            {
                this.Content = typeof(Label).Name;
            }
        }
        ...
        #region ContentInternal

        /// <summary>
        /// Identifies the ContentInternal dependency property.
        /// </summary>
        private static readonly DependencyProperty ContentInternalProperty =
        ...
        private string ContentInternal
        {
            get
            {
                return GetValue(ContentInternalProperty) as string;
            }

            set
            {
                SetValue(ContentInternalProperty, value);
            }
        }

        #endregion ContentInternal
        ...
        {
            // Reset binding to from Content to ContentInternal, overwriting any changes that might have been made to the Label.Content property.
            // This will set Content to be bound to ContentInternal, which is automatically generated with a string denoting the caption of the target.
            // If the Content property is explicity set, this binding will break and instead show the new content. Refresh() can be called to revert
            // back to the autogenerated value.
            Binding binding = new Binding("ContentInternal");
        ...
        private void LoadMetadata(bool forceUpdate)
        {
            ...
            if (this.ValidationMetadata != vmd)
            {
                ...
                SetValue(Label.ContentInternalProperty, newContent);
