...
''' </summary>
<SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId:="Expander", Justification:="Name of the control"), Sample("Expander", DifficultyLevel.Basic), Category("Expander")> _
