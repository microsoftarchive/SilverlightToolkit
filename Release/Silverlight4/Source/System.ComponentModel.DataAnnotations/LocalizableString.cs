        ...
        public string GetLocalizableValue() {
            if (this._cachedResult == null) {
                ...
                if (this._propertyValue == null || this._resourceType == null) {
                    ...
                    if (badlyConfigured) {
                        string exceptionMessage = String.Format(CultureInfo.CurrentCulture, DataAnnotationsResources.LocalizableString_LocalizationFailed, this._propertyName, this._resourceType.FullName, this._propertyValue);
