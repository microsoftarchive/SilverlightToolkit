...
namespace System.Windows.Controls.Test
{
    ...
    public class DataDrtTest_P0 : SilverlightControlTest
    {
        ...
        public void DataGrid_P0()
        {
            ...
            {
                Assert.IsTrue(dataGrid.SlotCount > 0);
                Assert.IsTrue(dataGrid.Columns.Count > 0);
                Assert.IsTrue(dataGrid.Columns[0].Width.DesiredValue > 0);
                ...
                Assert.IsTrue(dataGrid.DisplayData.FirstScrollingSlot != -1);
                Assert.IsTrue(dataGrid.DisplayData.LastScrollingSlot != -1);
