    ...
    internal class DataPagerMetadata : AttributeTableBuilder
    {
            ...
            : base()
        {
            AddCallback(
                ...
                {
                    // Common
                    b.AddCustomAttributes(new DefaultBindingPropertyAttribute(Extensions.GetMemberName<SSWC.DataPager>(x => x.Source)));
                    ...
                    b.AddCustomAttributes(Extensions.GetMemberName<SSWC.DataPager>(x => x.Source), new CategoryAttribute(Properties.Resources.CommonProperties));
                });
        }
    }
}
