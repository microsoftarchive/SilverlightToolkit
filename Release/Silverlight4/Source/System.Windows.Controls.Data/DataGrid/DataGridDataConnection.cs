    ...
    internal class DataGridDataConnection
    {
        ...
        public Type DataType
        {
            get
            {
                if (_dataType == null)
                {
                    if (this.CollectionView != null && this.CollectionView.SourceCollection != null)
                    {
                        // If we're given an ICollectionView, we need to look at the SourceCollection
                        _dataType = this.CollectionView.SourceCollection.GetItemType();
                    }
                    else if (_owner.ItemsSource != null)
                    {
                        // Use the raw ItemsSource
        ...
        public bool GetPropertyIsReadOnly(string propertyName)
        {
            if (this.DataType != null)
            {
                if (!String.IsNullOrEmpty(propertyName))
                {
                    ...
                    string[] propertyNames = propertyName.Split(TypeHelper.PropertyNameSeparator);
