...
namespace System.Windows.Controls.Testing
{
    ...
    public static partial class UIElementExtensions
    {
        ...
        public static IObservable<Event<EventArgs>> GetLayoutUpdated(this FrameworkElement that)
        {
        ...
        /// event.</returns>
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "It's necessary to nest generic types.")]
        public static IObservable<Event<EventArgs>> GetNextLayoutUpdated(this FrameworkElement that)
        {
        ...
        /// </returns>
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "It's necessary to nest generic types.")]
        public static IObservable<Event<SizeChangedEventArgs>> GetSizeChanged(this FrameworkElement that)
        {
        ...
        /// event.</returns>
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "It's necessary to nest generic types.")]
        public static IObservable<Event<SizeChangedEventArgs>> GetNextSizeChanged(this FrameworkElement that)
        {
        ...
        {
            SynchronizationContext uiThreadContext = SynchronizationContext.Current;
            return
                Observable.Merge(
                    that.GetNextSizeChanged().IgnoreAll(),
                    that.GetNextLayoutUpdated().IgnoreAll(),
                    that.GetBeginInvoke().Delay(2000).Post(uiThreadContext))
                    .Take(1);
        }
        ...
        public static IObservable<Event<KeyEventArgs>> GetKeyUpAlways(this UIElement that)
        {
        ...
        /// </returns>
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures", Justification = "Rx observables based on events are implemented this way.")]
        public static IObservable<Event<RoutedEventArgs>> GetGotFocus(this UIElement that)
        {
