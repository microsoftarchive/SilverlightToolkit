...
//-----------------------------------------------------------------------------
// Crc32.cs originally from the http://ironpython.codeplex.com/ site.
//-----------------------------------------------------------------------------
...
namespace System.IO.Compression
{
    ...
    internal class Crc32
    {
        ...
        /// See RFC1952 for details.
        /// </summary>
        /// <param name="buffer">The buffer of bytes where the range of bytes to
        /// checksum exist.</param>
        /// <param name="offset">The start index of the range of bytes to
        /// checksum.</param>
        /// <param name="length">The length of the range of bytes to checksum.</param>
        /// <returns>Returns the CRC for the range of bytes.</returns>
        ...
        /// See RFC1952 for details.
        /// 
        /// CRCs can be computed in chunks, where you take the CRC of the 
        /// preceeding block of data and use this as the 'crc32' to compute the
        /// next chunk.  
        /// </summary>  
        /// <param name="crc32">The byte buffer.</param>
        /// <param name="buffer">The crc32.</param>
        /// <param name="offset">The buffer length.</param>
