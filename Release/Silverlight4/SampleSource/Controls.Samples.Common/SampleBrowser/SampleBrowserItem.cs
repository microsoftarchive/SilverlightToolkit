...
namespace System.Windows.Controls.Samples
{
    ...
    public class SampleBrowserItem
    {
        ...
        /// <summary>
        /// Gets the sample creator.
        /// </summary>
        public PartCreator<FrameworkElement, ISampleMetadata> PartCreator { get; private set; }
        ...
        /// <param name="sampleCreator">Creator for the sample.</param>
        private SampleBrowserItem(string name, PartCreator<FrameworkElement, ISampleMetadata> sampleCreator)
        {
            Name = name;
            PartCreator = sampleCreator;
            OriginalName = sampleCreator.Metadata.Name;
            SampleLevel = sampleCreator.Metadata.DifficultyLevel;
        }
        ...
        public FrameworkElement GetSample()
        {
            ...
            FrameworkElement sample = PartCreator.CreatePart().ExportedValue;
        ...
        /// <param name="sample">PartCreator for the sample to add.</param>
        internal static void AddSample(IList<SampleBrowserItem> Samples, PartCreator<FrameworkElement, ISampleMetadata> sample)
        {
