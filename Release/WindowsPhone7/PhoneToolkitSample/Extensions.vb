...
Public Class PublicGrouping(Of TKey, TElement)
    Implements System.Linq.IGrouping(Of TKey, TElement)
    Private ReadOnly _internalGrouping As System.Linq.IGrouping(Of TKey, TElement)

    Public Sub New(ByVal internalGrouping As System.Linq.IGrouping(Of TKey, TElement))
...
#Region "IGrouping<TKey,TElement> Members"
    ...
    Public ReadOnly Property Key As TKey Implements System.Linq.IGrouping(Of TKey, TElement).Key
        Get
...
#Region "IEnumerable<TElement> Members"
    ...
    Public Function GetEnumerator() As IEnumerator(Of TElement) Implements System.Collections.Generic.IEnumerable(Of TElement).GetEnumerator
