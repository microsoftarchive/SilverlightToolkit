...
''' </summary>
<Sample("Theme Browser", DifficultyLevel.Basic), Category("Theme Browser")> _
Partial Public Class ThemeBrowserSample
    ...
    Private Sub ShowTheme(ByVal item As ThemeCatalogItem)
        ...
        Dim uri As New Uri(item.ThemeXamlPath, UriKind.Relative)
        ImplicitStyleManager.SetResourceDictionaryUri(demo, uri)
        ImplicitStyleManager.SetApplyMode(demo, ImplicitStylesApplyMode.Auto)
        ImplicitStyleManager.Apply(demo)
    End Sub
