...
namespace System.Windows.Controls.Theming
{
    ...
    internal static partial class ResourceParser
    {
            ...
            while (reader.Read())
            {
                switch (reader.NodeType)
                {
                    ...
                    case XmlNodeType.EndElement:
                        ...
                        // Clean up the extra Resources tag we added in the
                        // ParseElement method
                        if (reader.Depth == 0)
                        {
                            writer.WriteFullEndElement();
        ...
        private static void ParseElement(XmlReader reader, XmlWriter writer, bool checkTypes)
        {
            ...
            // If element is a ResourceDictionary and it is the root element
            // write a ContentControl tag to the output stream along with a
            // nested Resources tag
            if (reader.Depth == 0)
            {
                ...
                {
                    throw new InvalidOperationException(Properties.Resources.ImplicitStyleManager_Parse_CanOnlyParseXAMLFilesWithResourceDictionaryAsTheRootElement);
                }
