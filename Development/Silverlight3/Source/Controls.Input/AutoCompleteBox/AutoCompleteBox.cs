...
namespace System.Windows.Controls
{
    ...
    public partial class AutoCompleteBox : Control, IUpdateVisualState
    {
        ...
        /// </summary>
        private BindingEvaluator<string> ValueBindingEvaluator { get; set; }
        ...
        /// <summary>
        /// Gets or sets the string value binding for item-to-string value 
        /// conversions.
        /// </summary>
        public Binding ValueMemberBinding
        {
            get { return ValueBindingEvaluator != null ? ValueBindingEvaluator.ValueBinding : null; }
            set { ValueBindingEvaluator = new BindingEvaluator<string>(value); }
        }
        ...
        {
            if (ValueBindingEvaluator != null)
            {
                return ValueBindingEvaluator.GetDynamicValue(value) ?? string.Empty;
            }
