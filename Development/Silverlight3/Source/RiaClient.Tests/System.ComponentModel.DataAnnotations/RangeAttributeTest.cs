...
namespace System.ComponentModel.DataAnnotations.Test {
    ...
    public class RangeAttributeTest {
        ...
        public void RangeAttribute_Fail_Constructor_ArbitraryType_NotComparableType() {
            ...
            ExceptionHelper.ExpectException<InvalidOperationException>(delegate() {
                attr.IsValid(2);
            }, "The type System.ComponentModel.DataAnnotations.Test.RangeAttributeTest must implement System.IComparable.");
        }
        ...
        public void RangeAttribute_Constructor_Double_MinGreaterThanMax() {
            ...
            ExceptionHelper.ExpectException<InvalidOperationException>(delegate() {
                attr.IsValid(10.0);
            }, "The maximum value '10.5' must be greater than or equal to the minimum value '1000000000.5'.");
        }
        ...
        public void RangeAttribute_IsValid_Double_As_String() {
            AssertAreTrue(new RangeAttribute(typeof(double), "0.0", "100.0"), 0.0, 50.0, 100.0);
            AssertAreFalse(new RangeAttribute(typeof(double), "0.0", "100.0"), -100.0, 200.0);
        }
        ...
        public void RangeAttribute_FormatErrorMessage() {
            ...
            Assert.AreEqual("The field SOME_NAME must be between -100.3 and 10000000.5.", attrib.FormatErrorMessage("SOME_NAME"));
        }
        ...
        public void RangeAttribute_Fail_Int32_Min_Exceed_Max() {
            ...
            "The maximum value '1' must be greater than or equal to the minimum value '3'.");
        }
        ...
        public void RangeAttribute_Fail_String_Min_Exceed_Max() {
            var attr = new RangeAttribute(typeof(float), "3.0", "1.0");
            ExceptionHelper.ExpectException<InvalidOperationException>(delegate() {
                attr.IsValid(2.0f);
            },
            "The maximum value '1' must be greater than or equal to the minimum value '3'.");
