...
namespace System.ComponentModel.DataAnnotations.Test {
    ...
    public class EnumDataTypeAttributeTest {
        ...
        public void EnumDataTypeAttribute_Null() {
            ...
            ExceptionHelper.ExpectInvalidOperationException(delegate() { target.IsValid("any value"); }, "The type provided for EnumDataTypeAttribute cannot be null.");
        }

        [TestMethod()]
        public void EnumDataTypeAttribute_NotEnum() {
            EnumDataTypeAttribute target = new EnumDataTypeAttribute(typeof(string));
            ExceptionHelper.ExpectInvalidOperationException(delegate() { target.IsValid("any value"); }, "The type 'System.String' needs to represent an enumeration type.");
        }
