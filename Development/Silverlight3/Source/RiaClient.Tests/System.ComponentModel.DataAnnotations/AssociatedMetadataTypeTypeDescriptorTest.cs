...
namespace System.ComponentModel.DataAnnotations.Test {
    ...
    public class AssociatedMetadataTypeTypeDescriptorTest {
        ...
        [TestMethod]
        public void SameAttributeDefinedBothOnMainAndAssociatedType() {

            // Removing this check per bug DevDiv 200490

            //ExceptionHelper.ExpectException<InvalidOperationException>(delegate() {
            //    GetTypeDescriptorHelper(typeof(TestTableWithExtraMetadataConflict)).GetAttributes();
            //}, "The main type 'System.ComponentModel.DataAnnotations.Test.AssociatedMetadataTypeTypeDescriptorTest+TestTableWithExtraMetadataConflict' already contains at least one attribute of type 'System.ComponentModel.DataAnnotations.DisplayColumnAttribute'.");
        }
        ...
        public void InvalidAssociatedType() {
            ...
            }, "The associated metadata type for type 'System.ComponentModel.DataAnnotations.Test.AssociatedMetadataTypeTypeDescriptorTest+TestTableInvalid' contains the following unknown properties or fields: WrongPropertyName, AnotherWrongProperty, WrongFieldName, AnotherWrongFieldName. Please make sure that the names of these members match the names of the properties on the main type.");
        }
