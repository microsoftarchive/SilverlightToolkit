namespace System.ComponentModel.DataAnnotations.Test {
    ...
    public static class UnitTestHelper {
        ...
        //public static ITemplate CreateMockTemplate(params Control[] controls)
        //{
        //    Mock<ITemplate> templateMock = new Mock<ITemplate>();
        //    templateMock.Implement("InstantiateIn",
        //        new object[] { MockConstraint.IsAnything<Control>() },
        //        delegate(object obj, MethodInfo method, object[] arguments)
        //        {
        //            Control templateContainer = (Control)arguments[0];
        //            if (controls != null)
        //            {
