...
namespace System.Windows.Navigation.UnitTests
{
    ...
    /// </summary>
    [TestClass]
    public sealed class InternalJournalTests : SilverlightTest
    {
        #region Fields
        ...
        {
            this.Journal.BrowserIntegrated = false;
            AddHistoryPointCore();
        }
        ...
        {
            this.Journal.BrowserIntegrated = true;
            AddHistoryPointCore();
        }
