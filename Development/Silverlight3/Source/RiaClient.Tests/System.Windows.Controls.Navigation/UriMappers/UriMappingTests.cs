...
namespace System.Windows.Navigation.UnitTests
{
    ...
    public class UriMappingTests : SilverlightTest
    {
        ...
        public void SimpleMatchOriginalUriQueryStringPreserved()
        {
            ...
            Assert.IsNotNull(result);
            IDictionary<string, string> queryStringValues = UriParsingHelper.InternalUriParseQueryStringToDictionary(result);
        ...
        [TestMethod]
        [Description("If no 'Uri' template was specified, throw on MapUri")]
        public void NoUriTemplateThrows()
        {
            string MappedUriPattern = "Result.xaml?id={x}";
