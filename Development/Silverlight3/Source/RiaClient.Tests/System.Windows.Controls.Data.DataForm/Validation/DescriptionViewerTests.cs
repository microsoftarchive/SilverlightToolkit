...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DescriptionViewerTests : SilverlightControlTest
    {
        ...
        [TestMethod]
        [Description("Test the Description DP.  Updating the CLR property will set it into override mode.")]
        [Asynchronous]
        ...
        [TestMethod]
        [Description("Test the GlyphTemplate DP.")]
        [Asynchronous]
        ...
        [TestMethod]
        [Description("Test the ToolTipStyle DP.")]
        [Asynchronous]
        ...
        public void Target_ValidChecks()
        {
            ...
            {
                Assert.AreEqual("This is your first name.", page.nameDescriptionViewer.Description);
                Assert.IsTrue(page.nameDescriptionViewer.IsValidInternal);
                page.nameTextBox.Text = "ABCDEF!@#1";
                Assert.IsFalse(page.nameDescriptionViewer.IsValidInternal);
        ...
        public void Target_ValidChecksWithTargetChanges()
        {
            ...
            {
                Assert.AreEqual("This is your first name.", page.nameDescriptionViewer.Description);
                Assert.IsTrue(page.nameDescriptionViewer.IsValidInternal, "initial valid state");
                page.nameTextBox.Text = "ABCDEF!@#1";
                Assert.IsFalse(page.nameDescriptionViewer.IsValidInternal, "invalid data");
                page.nameDescriptionViewer.Target = page.emailTextBox;
                Assert.IsTrue(page.nameDescriptionViewer.IsValidInternal, "switch to valid target");
                page.nameDescriptionViewer.Target = page.nameTextBox;
                Assert.IsFalse(page.nameDescriptionViewer.IsValidInternal, "switch back to invalid target");
                page.nameTextBox.Text = "ABC";
                Assert.IsTrue(page.nameDescriptionViewer.IsValidInternal, "turned valid again");
                page.emailTextBox.Text = "asdfkhask";
                page.nameDescriptionViewer.Target = page.emailTextBox;
                Assert.IsFalse(page.nameDescriptionViewer.IsValidInternal, "switch to second, invalid target");
                page.nameDescriptionViewer.Target = null;
                Assert.IsTrue(page.nameDescriptionViewer.IsValidInternal, "no target");
            });
            EnqueueTestComplete();
        }
