    ...
    public class DataFormTests_InsertingDeleting : DataFormTests_Base
    {
        ...
        public void AddItem()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                Assert.IsTrue(this.DataForm.AddItem());
            });
        ...
        public void CancelAddingItem()
        {
            ...
            this.EnqueueCallback(() =>
            {
                this.DataForm.AddingItem += new EventHandler<System.ComponentModel.CancelEventArgs>(OnDataFormAddingItem);
                Assert.IsFalse(this.DataForm.AddItem());
            });
        ...
        {
            this.dataClassList = DataClassList.GetDataClassList(3, ListOperations.Add | ListOperations.Edit);
            this.DataForm.ItemsSource = this.dataClassList;
            this.AddToPanelAndWaitForLoad();
        ...
        {
            this.dataClassList = DataClassList.GetDataClassList(3, ListOperations.Edit | ListOperations.Remove);
            this.DataForm.ItemsSource = this.dataClassList;
            this.AddToPanelAndWaitForLoad();
        ...
        /// <summary>
        /// Ensure that setting IsUserAbleToAddItems to false disables addition.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Ensure that setting IsUserAbleToAddItems to false disables addition.")]
        public void SetIsUserAbleToAddItemsToFalse()
        {
            this.AddToPanelAndWaitForLoad();

            this.EnqueueCallback(() =>
            {
                this.DataForm.CanUserAddItems = false;
                ButtonBase newItemButton = this.GetTemplatePart<ButtonBase>("NewItemButton");
                Assert.IsFalse(this.DataForm.IsUserAbleToAddItems);
                Assert.IsFalse(newItemButton.IsEnabled);
            });
        ...
        /// <summary>
        /// Ensure that setting IsUserAbleToDeleteItems to false disables deletion.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Ensure that setting IsUserAbleToDeleteItems to false disables deletion.")]
        public void SetIsUserAbleToDeleteItemsToFalse()
        {
            this.AddToPanelAndWaitForLoad();

            this.EnqueueCallback(() =>
            {
                this.DataForm.CanUserDeleteItems = false;
                ButtonBase deleteItemButton = this.GetTemplatePart<ButtonBase>("DeleteItemButton");
                Assert.IsFalse(this.DataForm.IsUserAbleToDeleteItems);
                Assert.IsFalse(deleteItemButton.IsEnabled);
            });
        ...
        private void OnDataFormAddingItem(object sender, System.ComponentModel.CancelEventArgs e)
        {
            e.Cancel = true;
        }
