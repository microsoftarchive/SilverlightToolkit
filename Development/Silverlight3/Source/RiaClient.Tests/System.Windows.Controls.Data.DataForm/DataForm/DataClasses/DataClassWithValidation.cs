//-----------------------------------------------------------------------
// <copyright company="Microsoft" file="DataClassWithValidation.cs">
...
namespace System.Windows.Controls.UnitTests
{
    ...
    /// </summary>
    [CustomValidation(typeof(DataClassWithValidationValidator), "IsDataClassWithValidationValid")]
    public class DataClassWithValidation : IEditableObject, INotifyPropertyChanged, IRevertibleChangeTracking
    {
        /// <summary>
        ...
        /// </summary>
        private DataClassWithValidation oldDataClass;
        ...
        /// </summary>
        private DataClassWithValidation unchangedDataClass;
        ...
        [DataMember()]
        [Range(0, 7, ErrorMessage = "IntProperty must be between 0 and 7.")]
        ...
        [DataMember()]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", MessageId = "int", Justification = "This property is only used in unit tests.")]
        [Display(Name = "Int Property Without BindableAttribute")]
        ...
        [DataMember()]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", MessageId = "int", Justification = "This property is only used in unit tests.")]
        [Display(Name = "Non-Bindable Int Property")]
        ...
        [Required(ErrorMessage = "StringProperty is required.")]
        [StringLength(20, ErrorMessage = "StringProperty must be at most 20 characters.")]
