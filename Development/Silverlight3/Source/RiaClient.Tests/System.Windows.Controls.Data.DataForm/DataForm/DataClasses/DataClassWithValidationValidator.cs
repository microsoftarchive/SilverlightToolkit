...
namespace System.Windows.Controls.UnitTests
{
    ...
    public static class DataClassWithValidationValidator
    {
        ...
        public static bool IsDataClassWithValidationValid(object value, ValidationContext context, out ValidationResult result)
        {
            result = null;
            ...
            {
                result = new ValidationResult("IntProperty cannot be equal to StringProperty.");
                return false;
            }
