...
namespace System.Windows.Controls.UnitTests
{
    ...
    public class DataFormTests_TemplateParts : DataFormTests_Base
    {
        ...
        /// <summary>
        /// Ensure that the template part FieldsPresenter can be retrieved.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Ensure that the template part FieldsPresenter can be retrieved.")]
        public void GetFieldsPresenter()
        {
            this.ExpectTemplatePart<ContentPresenter>("FieldsPresenter");
        }

        /// <summary>
        /// Ensure that the template part ErrorSummary can be retrieved.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Ensure that the template part ErrorSummary can be retrieved.")]
        public void GetErrorSummary()
        {
            this.ExpectTemplatePart<ErrorSummary>("ErrorSummary");
        }
        ...
        public void EnsureTemplatePartsThroughProperties()
        {
            ...
            this.EnqueueCallback(() =>
            {
                ...
                Assert.IsNotNull(dataFormApp.dataForm.ErrorSummary);
                Assert.IsNotNull(dataFormApp.dataForm.ErrorSummary.Style);
                Assert.AreEqual(20, dataFormApp.dataForm.ErrorSummary.FontSize);
            });
