...
namespace System.Windows.Controls.Data.Test.DataClasses
{
    ...
    public static class CustomerValidator
    {
        ...
        public static bool IsFullNameValidLength(object customerObject, ValidationContext context, out ValidationResult validationResult)
        {
            ...
            if (!isValid)
            {
                validationResult = IsFullNameValidLength_ValidationResult;
            }
            return isValid;
        }
        ...
        public static bool IsRegisteredValid(object customerObject, ValidationContext context, out ValidationResult validationResult)
        {
            validationResult = null;
            Customer customer = customerObject as Customer;
            if (!customer.Validate)
            ...
            if (!isValid)
            {
                validationResult = IsRegisteredValid_ValidationResult;
            }
            return isValid;
        }
        ...
        public static bool IsRatingValid(object customerObject, ValidationContext context, out ValidationResult validationResult)
        {
            ...
            if (!isValid)
            {
                validationResult = IsRatingValid_ValidationResult;
            }
            return isValid;
        }
