        ...
        where TDataClassSource : DataClassSource<TDataClass>, new()
    {
        ...
        public void ColumnReorderingByMouse()
        {
            ...
            EnqueueCallback(
                delegate
                {
                    ...
                    column1.HeaderCell.OnMouseMove(ref handled, new Point(distanceToMove, 0), new Point(distanceToMove, 0));
                }
            );
            ...
            EnqueueCallback(
                delegate
                {
                    ...
                    column1.HeaderCell.OnMouseLeftButtonUp(ref handled, new Point(totalDistanceMoved, 0));
                }
            );
        ...
        public virtual void VisualTreeCount()
        {
            ...
            EnqueueCallback(delegate
            {
                ...
                Assert.AreEqual(56, CountVisualTreeRecursively(dataGrid), "New number of elements in dataGrid visual tree");
            });
