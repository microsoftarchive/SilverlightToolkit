...
{
    /// <summary>
    /// Used within the template of a <see cref="T:System.Windows.Controls.DataGrid" /> to specify \
    /// the location in the control's visual tree where the cells are to be added.
    /// </summary>
