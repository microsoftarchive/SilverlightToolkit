...
namespace System.Windows.Controls
{
    ...
    public class DataGridRowGroupHeader : Control
    {
        ...
        #region HeaderStyle
        /// <summary>
        /// Style of the RowGroupHeader's HeaderCell
        /// </summary>
        ...
        #region PropertyName
        /// <summary>
        /// Property of the entity that this DataGridRowGroupHeader applies to
        /// </summary>
        ...
        /// <summary>
        /// Visibility of the PropertyName
        /// </summary>
        ...
        /// <summary>
        /// Amount to indent the RowGroupHeader's children
        /// </summary>
        ...
        internal void EnsureExpanderButtonChecked()
        {
            ...
            {
                _expanderButton.IsChecked = this.RowGroupInfo.Visibility == Visibility.Visible;
            }
        }
        ...
        {
            ToggleExpandCollapse(false /*updateExpanderButton*/);
        }

        internal void LoadVisualsForDisplay()
        {
            EnsureExpanderButtonChecked();
        ...
        public override void OnApplyTemplate()
        {
            ...
            {
                EnsureExpanderButtonChecked();
                _expanderButton.Click += new RoutedEventHandler(ExpanderButton_Click);
            }
        ...
        {
            if (this.OwningGrid != null && this.OwningGrid.IsDoubleClickRecordsClickOnCall(this))
            {
                ToggleExpandCollapse(true /*updateExpanderButton*/);
            }
        }

        internal void ToggleExpandCollapse(bool updateExpanderButton)
        {
            if (this.RowGroupInfo.CollectionViewGroup.ItemCount != 0)
            {
                Visibility newVisibility = this.RowGroupInfo.Visibility == Visibility.Visible ? Visibility.Collapsed : Visibility.Visible;
                ...
                else if (!this.OwningGrid.OnRowGroupHeaderToggled(this, newVisibility))
                {
                    return;
                }

                if (updateExpanderButton)
                {
                    EnsureExpanderButtonChecked();
                }
