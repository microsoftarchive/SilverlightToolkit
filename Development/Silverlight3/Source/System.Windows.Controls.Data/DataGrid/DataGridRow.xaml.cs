...
*/
        ...
        #region IsValid
        /// <summary>
        /// Gets a value indicating that the DataGridRow is in a valid state. 
        /// </summary>
        public bool IsValid
        {
            get
        ...
        {
            if (this.AreDetailsVisible && this.OwningGrid != null && this.OwningGrid.IsSlotVisible(this.Slot))
            {
