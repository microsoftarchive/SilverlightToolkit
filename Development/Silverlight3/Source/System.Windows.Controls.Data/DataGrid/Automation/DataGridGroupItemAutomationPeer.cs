...
namespace System.Windows.Automation.Peers
{
    ...
    sealed public class DataGridGroupItemAutomationPeer : FrameworkElementAutomationPeer,
        IExpandCollapseProvider, IGridProvider, IScrollItemProvider, ISelectionProvider
    {
        ...
        {
            return (this.OwningRowGroupHeaderPeer != null) ? this.OwningRowGroupHeaderPeer.GetAutomationId() : string.Empty;
        }
        ...
        {
            string name = _group.Name as string;
            if (name != null)
            {
                return name;
            }
        ...
        IRawElementProviderSimple IGridProvider.GetItem(int row, int column)
        {
                ...
                column >= 0 && column < this.OwningDataGrid.Columns.Count)
            {
                ...
                if (groupInfo != null)
                {
                    ...
                    this.OwningDataGrid.ScrollSlotIntoView(column, slot, false /*forCurrentCellChange*/, true /*forceHorizontalScroll*/);
