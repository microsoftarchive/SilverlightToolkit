...
{
    /// <summary>
    /// Provides a converter to convert DateTime objects to and from other
    /// representations.
    /// </summary>
    ...
    {
        /// <summary>
        /// Gets a value that indicates whether it is possible to convert the
        /// specified type to a DateTime with the specified format context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>
        /// Converts the specified object to a DateTime with the specified
        /// culture with the specified format context.
        /// </summary>
        /// <param name="context">
        /// The format context that is used to convert the specified type.
        /// </param>
        ...
        /// <returns>A DateTime object that represents value.</returns>
        ...
        /// <summary>
        /// Gets a value that indicates whether it is possible to convert a
        /// DateTime to the specified type within the specified format context.
        /// </summary>
        /// <param name="context">
        ...
        /// <summary>
        /// Converts a DateTime with the specified culture to the specified
        /// object with the specified format context.
        /// </summary>
        /// <param name="context">
