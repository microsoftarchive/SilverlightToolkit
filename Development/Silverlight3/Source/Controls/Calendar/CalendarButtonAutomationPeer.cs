...
namespace System.Windows.Automation.Peers
{
        ...
        ISelectionItemProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the CalendarButtonAutomationPeer
        /// class.
        /// </summary>
        /// <param name="owner">
        ...
        protected override string GetNameCore()
        {
            ...
            if (string.IsNullOrEmpty(name))
            {
                ...
                {
                    name = string.Format(DateTimeHelper.GetCurrentDateFormat(), OwningCalendarButton.Content.ToString());
                }
            }
            return name;
        }
