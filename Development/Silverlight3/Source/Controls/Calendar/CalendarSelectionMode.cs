...
namespace System.Windows.Controls
{
    ...
    {
        /// <summary>
        /// Only a single date can be selected. Use the SelectedDate property to
        /// retrieve the selected date.
        /// </summary>
        SingleDate = 0,

        /// <summary>
        /// A single range of dates can be selected. Use the SelectedDates
        ...
        /// SelectedDates property to retrieve the selected dates.
        /// </summary>
        MultipleRange = 2,
