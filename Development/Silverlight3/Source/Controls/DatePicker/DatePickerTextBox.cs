...
{
    /// <summary>
    /// DatePickerTextBox is a specialized form of TextBox which displays custom
    /// visuals when its contents are empty.
    /// </summary>
    ...
    public sealed partial class DatePickerTextBox : TextBox
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DatePickerTextBox"/>
        /// class.
        /// </summary>
            ...
            where T : DependencyObject
        {
            Debug.Assert(
                ...
                string.Format(CultureInfo.InvariantCulture, System.Windows.Controls.Properties.Resources.DatePickerTextBox_TemplatePartIsOfIncorrectType, partName, typeof(T).Name));
            return obj as T;
        }
        ...
        {
            IsEnabled = true;
            this.Watermark = System.Windows.Controls.Properties.Resources.DatePickerTextBox_DefaultWatermarkText;
        }
    }
}