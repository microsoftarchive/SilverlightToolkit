...
namespace System.Windows.Controls
{
    ...
    public partial class DatePicker : Control
    {
        ...
        /// <summary>
        /// Occurs when text entered into the DatePicker cannot be parsed or the
        /// Date is not valid to be selected.
        /// </summary>
        ...
        private static void OnSelectedDateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dp.SelectedDate != null)
            {
                ...
                dp.Dispatcher.BeginInvoke(delegate
                {
                    ...
                    dp.OnDateSelected(new SelectionChangedEventArgs(removedItems, addedItems));
                });
        ...
        private static void OnSelectedDateFormatChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("d", System.Windows.Controls.Properties.Resources.DatePicker_OnSelectedDateFormatChanged_InvalidValue);
            }
        }
        ...
        /// <summary>
        /// Builds the visual tree for the DatePicker control when a new
        /// template is applied.
        /// </summary>
        ...
        /// </summary>
        /// <param name="e">
        /// A DatePickerDateValidationErrorEventArgs that contains the event
        /// data.
        /// </param>
        ...
        private void SetWaterMarkText()
        {
            if (this._textBox != null)
            {
                ...
                switch (this.SelectedDateFormat)
                {
                    case DatePickerFormat.Long:
                        {
                            this._textBox.Watermark = string.Format(CultureInfo.CurrentCulture, System.Windows.Controls.Properties.Resources.DatePicker_WatermarkText, dtfi.LongDatePattern.ToString());
                            break;
                        }
                    case DatePickerFormat.Short:
                        {
                            this._textBox.Watermark = string.Format(CultureInfo.CurrentCulture, System.Windows.Controls.Properties.Resources.DatePicker_WatermarkText, dtfi.ShortDatePattern.ToString());
                            break;
                        }
                }
            }
