...
namespace System.Windows.Controls
{
    ...
    public partial class GridSplitter : Control
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the GridSplitter control
        /// updates the column or row size as the user drags the control.  This
        ...
        /// <summary>
        /// Gets or sets the style that customizes the appearance, effects, or
        /// other style characteristics for the GridSplitter control preview
        /// indicator that is displayed when the ShowsPreview property is set to
        /// true.  This is a dependency property.
        /// </summary>
        ...
        /// (<see cref="UIElement.OnCreateAutomationPeer"/>).
        /// </summary>
