...
namespace System.Windows.Controls
{
    ...
    public class ListTimePickerPopup : TimePickerPopup
    {
        ...
        public ItemSelectionHelper<KeyValuePair<string, DateTime?>> TimeItemsSelection
        {
            ...
            private set { SetValue(TimeItemsSelectionProperty, value); }
        }
        ...
        public ListTimePickerPopup() : base()
        {
            ...
            SetValue(TimeItemsSelectionProperty, new ItemSelectionHelper<KeyValuePair<string, DateTime?>>());
            TimeItemsSelection.Items = new ObservableCollection<KeyValuePair<string, DateTime?>>();
        }
        ...
        {
            // workaround for SL3 running SL2 bits: Thumb is raising the event.
            FrameworkElement element = e.OriginalSource as FrameworkElement;
            if (element != null && element.DataContext != ListBoxPart.DataContext)
            {
                // all the visual elements in the ListBox that might raise this
                // event have the same DataContext as the ListBoxPart.
                // only an actual ListBoxItem has a different context.
                DoCommit();
            }
        }
