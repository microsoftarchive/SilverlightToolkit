...
namespace System.Windows.Controls
{
    ...
    public class TimePicker : Picker, ITimeInput
    {
        ...
        /// </summary>
        internal const string ElementTimeUpDownName = "TimeUpDown";

        /// <summary>
        /// The name for the TimeUpDownStyle element.
        /// </summary>
        internal const string TimeUpDownStyleName = "TimeUpDownStyle";
        ...
        internal TimeUpDown TimeUpDownPart
        {
        ...
        /// </summary>
        internal ContentControl PopupPlaceHolderPart
        {
            ...
            set
            {
                ...
                if (_popupPlaceHolderPart != null)
                {
                    if (Popup != null)
                    {
                        _popupPlaceHolderPart.Content = Popup;
                    }
                }
            }
        }
        ...
        private static void OnMinimumPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.Popup != null)
            {
                source.Popup.Minimum = newValue;
            }
        }
        ...
        private static void OnCulturePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.Popup != null)
            {
                source.Popup.Culture = e.NewValue as CultureInfo;
            }
        }
        ...
        private static void OnTimeGlobalizationInfoPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.Popup != null)
            {
                source.Popup.TimeGlobalizationInfo = newValue;
            }
        }
        ...
        private static void OnPopupPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            source.OnPopupChanged(oldValue, newValue);
        }
        ...
        private static void OnPopupSecondsIntervalPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.Popup != null)
            {
                source.Popup.PopupSecondsInterval = value;
            }
        }
        ...
        private static void OnPopupMinutesIntervalPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.Popup != null)
            {
                source.Popup.PopupMinutesInterval = value;
            }
        }
        ...
        private static void OnPopupTimeSelectionModePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (// value != PopupTimeSelectionMode.AllowTimeDesignatorsSelection &&
            ...
            if (source.Popup != null)
            {
                source.Popup.PopupTimeSelectionMode = value;
            }
        }
        ...
        public TimePicker()
        {
            ...
            SetValue(PopupProperty, new ListTimePickerPopup());
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            PopupPlaceHolderPart = GetTemplateChild("PopupPlaceHolder") as ContentControl;
        }
        ...
        protected override void OnDropDownClosed(RoutedPropertyChangedEventArgs<bool> e)
        {
            ...
            TimePickerPopup popup = Popup as TimePickerPopup;
            if (popup != null)
            {
                popup.OnClosed();
                popup.ValueChanged -= PopupValueChanged;
        ...
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "oldValue", Justification = "Changed method should have oldvalue.")]
        private void OnPopupChanged(TimePickerPopup oldValue, TimePickerPopup newValue)
        {
            if (oldValue != null)
            {
                oldValue.TimePickerParent = null;
            }
            ...
            if (newValue != null)
            {
                ...
                {
                    PopupPlaceHolderPart.Content = newValue;
                }

                newValue.TimePickerParent = this;
            }
        }
