...
namespace System.Windows.Controls.Testing
{
    ...
    public class TimeUpDownTest : UpDownBaseTest<DateTime?>
    {
        ...
        /// <summary>
        /// Gets the balloon content property.
        /// </summary>
        /// <value>The balloon content property.</value>
        protected DependencyPropertyTest<TimeUpDown, object> BalloonContentProperty { get; private set; }
        ...
        public TimeUpDownTest()
        {
            ...
            BalloonContentProperty = new DependencyPropertyTest<TimeUpDown, object>(this, "BalloonContent")
            {
                Property = TimeUpDown.BalloonContentProperty,
                Initializer = initializer,
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            // BalloonContentProperty tests
            tests.Add(BalloonContentProperty.CheckDefaultValueTest);
            return tests;
        }
        ...
        public override void TemplateVisualStatesAreDefined()
        {
            ...
            Assert.AreEqual("BalloonHintStates", visualStates["BalloonHintOpened"]);
            Assert.AreEqual("BalloonHintStates", visualStates["BalloonHintClosed"]);
        ...
        public virtual void ShouldMaintainCursorLocationAfterSpin()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual(1, tud.DisplayTextBox.SelectionStart),
                () => tud.Decrement(),
                () => Assert.AreEqual(1, tud.DisplayTextBox.SelectionStart));
        }
        ...
        public virtual void ShouldNotMoveCaretPositionUnnecessarily()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual(7, tud.GetCursor()),
                () => tud.SetCursor(8),
                () => tud.Decrement(),  // will change to 11:59:59, which is an extra char
                ...
                () => tud.SetCursor(11),
                () => tud.Decrement(),
                () => Assert.AreEqual(11, tud.GetCursor()),
                () => tud.Increment(),
                () => Assert.AreEqual(11, tud.GetCursor()));
        }
        ...
        public virtual void ShouldShowBalloonTextCorrectly()
        {
            ...
            TestAsync(
                tud,
                () => tud.SetText("121314"),
                () => Assert.IsFalse(tud.BalloonContent.ToString().Contains("<")),
                () => tud.SetText("330"),
                () => Assert.IsTrue(tud.BalloonContent.ToString().Contains("<")),
                () => tud.SetText("230"),
                () => Assert.IsTrue(tud.BalloonContent.ToString().Contains("<")),
                () => tud.SetText("1300"),
                () => Assert.IsFalse(tud.BalloonContent.ToString().Contains("<")));
