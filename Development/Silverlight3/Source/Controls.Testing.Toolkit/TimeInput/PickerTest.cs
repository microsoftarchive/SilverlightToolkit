...
namespace System.Windows.Controls.Testing
{
    ...
    public abstract class PickerTest : ControlTest
    {
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(PopupButtonModeProperty.TemplateBindTest);
        ...
        public virtual void ShouldBeAbleToCancelDropDownClose()
        {
            ...
            TestTaskAsync(
                ...
                () => closecount = 0, // is fired by onapplytemplate, so reset it
                () => picker.IsDropDownOpen = false,
                () => Assert.IsTrue(picker.IsDropDownOpen),
                () => Assert.IsTrue(closecount == 0),
                () => allowedToClose = true,
                () => picker.IsDropDownOpen = false);
        ...
        {
            Picker picker = DefaultPickerToTest;
            Button button = new Button { Content = "A button to set focus to" };
