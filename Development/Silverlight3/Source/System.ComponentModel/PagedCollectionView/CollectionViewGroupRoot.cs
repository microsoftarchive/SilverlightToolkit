...
namespace System.Windows.Data
{
    ...
    internal class CollectionViewGroupRoot : CollectionViewGroupInternal, INotifyCollectionChanged
    {
        ...
        {
            this.AddToSubgroups(item, this, 0);
        }
        ...
        private void AddToSubgroup(object item, CollectionViewGroupInternal group, int level, object name)
        {
            ...
            for (int n = group.Items.Count; index < n; ++index)
            {
                ...
                if (group.GroupBy.NamesMatch(subgroup.Name, name))
                {
                    ...
                    this.AddToSubgroups(item, subgroup, level + 1);
                    return;
                }
            }
            ...
            this.InitializeGroup(subgroup, level + 1);
        ...
        /// <param name="group">Group to add item to</param>
        /// <param name="level">The level of grouping</param>
        private void AddToSubgroups(object item, CollectionViewGroupInternal group, int level)
        {
            ...
            else if ((nameList = name as ICollection) == null)
            {
                ...
                this.AddToSubgroup(item, group, level, name);
            }
            else
            {
                ...
                {
                    this.AddToSubgroup(item, group, level, o);
                }
            }
        }
