...
namespace System.Windows.Controls.Testing
{
    ...
    public partial class TreeViewTest : ItemsControlTest
    {
        ...
        /// <summary>
        /// Verify expanding a TreeViewItem at the edge of the ScrollViewer will
        /// scroll its children into view.
        /// </summary>
        [TestMethod]
        [Asynchronous]
        [Description("Verify expanding a TreeViewItem at the edge of the ScrollViewer will scroll its children into view.")]
        [Bug("535577 - TreeView - TreeViewItem at the edge of a scroll viewer does not show it's children after expanding", Fixed = true)]
        public virtual void ExpandTreeViewItemAtEdgeOfScrollViewer()
        {
            ...
            {
                Height = 100,
                ItemsSource = new object[] { 1, 2, 3, item }
            };
            ...
            TestAsync(
                ...
                () => Assert.AreNotEqual(0, scroller.VerticalOffset, "Should have scrolled after expanding last item!"));
        }
