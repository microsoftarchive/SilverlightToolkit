...
namespace System.ComponentModel.DataAnnotations {
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Design", "CA1019:DefineAccessorsForAttributeArguments", Justification = "The accessor is already readonly")]
    ...
    public class StringLengthAttribute : ValidationAttribute {
        ...
        public override string FormatErrorMessage(string name) {
            this.EnsureLegalLengths();
            return String.Format(CultureInfo.CurrentCulture, this.ErrorMessageString, name, this.MaximumLength);
        }
