...
namespace System.ComponentModel.DataAnnotations {
    ...
    public static class Validator {
        ...
        /// <returns><c>true</c> if the property is read-only</returns>
        /// <exception cref="ArgumentException">When the property does not exist</exception>
        public static bool IsPropertyReadOnly(object instance, string propertyName) {
            if (instance == null) {
                throw new ArgumentNullException("instance");
            }

            return _store.IsPropertyReadOnly(instance.GetType(), propertyName);
        }
        ...
        private static void EnsureValidPropertyType(string propertyName, Type propertyType, object value) {
            if (!CanBeAssigned(propertyType, value)) {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, DataAnnotationsResources.Property_Value_Wrong_Type, propertyName, propertyType), "value");
            }
        }
        ...
        private static IEnumerable<ValidationError> GetObjectValidationErrors(object instance, ValidationContext validationContext, bool validateAllProperties, bool breakOnFirstError) {
            ...
            // Then perform type-level validation against the instance
            ...
            foreach (KeyValuePair<ValidationContext, object> property in properties) {
                ...
                if (validateAllProperties) {
                    ...
                    if (reqAttr != null) {
                        ...
                        if (!reqAttr.TryValidate(property.Value, property.Key, out validationResult)) {
