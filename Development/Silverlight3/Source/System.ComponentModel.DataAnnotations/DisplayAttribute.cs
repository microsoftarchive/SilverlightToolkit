...
namespace System.ComponentModel.DataAnnotations {
    ...
    public sealed class DisplayAttribute : Attribute {
        ...
        /// </value>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1721:PropertyNamesShouldNotMatchGetMethods", Justification = "The property and method are a matched pair")]
        ...
        /// </summary>
        /// <remarks>
        /// Consumers of this method should utilize the <see cref="GetAutoGenerateField"/> method to retrieve the value.
        ...
        public bool AutoGenerateField {
            get {
                if (!_autoGenerateField.HasValue) {
                    throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, DataAnnotationsResources.DisplayAttribute_AutoGenerateFieldNotSet));
                }
        ...
        /// </summary>
        /// <remarks>
        /// Consumers of this method should utilize the <see cref="GetAutoGenerateFilter"/> method to retrieve the value.
        /// That method will return either return null if this property has not been set or the value that was used
        /// when setting this property.
        /// </remarks>
        /// <exception cref="System.InvalidOperationException">
        ...
        public bool AutoGenerateFilter {
            get {
                if (!_autoGenerateFilter.HasValue) {
                    throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, DataAnnotationsResources.DisplayAttribute_AutoGenerateFilterNotSet));
                }
        ...
        /// </exception>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate", Justification = "This method does work using a property of the same name")]
        ...
        /// <summary>
        /// Gets the value of <see cref="AutoGenerateField"/> if it has been set, or null.
        /// </summary>
        /// <returns>
        /// When <see cref="AutoGenerateField"/> has been set returns the value of that property.
        /// <para>
        /// When <see cref="AutoGenerateField"/> has not been set returns null.
        /// </para>
        /// </returns>
        ...
        /// <summary>
        /// Gets the value of <see cref="AutoGenerateFilter"/> if it has been set, or null.
        /// </summary>
        /// <returns>
        /// When <see cref="AutoGenerateFilter"/> has been set returns the value of that property.
        /// <para>
        /// When <see cref="AutoGenerateFilter"/> has not been set returns null.
        /// </para>
        /// </returns>
        [SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate", Justification = "This method does work using a property of the same name")]
