...
namespace Microsoft.Windows.Controls.DataVisualization.Charting
{
    ...
    /// </summary>
    public class AxisLabel : ContentControl
    {
        ...
        public AxisLabel()
        {
            ...
            this.SetBinding(FormattedContentProperty, new Binding { Converter = new StringFormatConverter(), ConverterParameter = StringFormat });
        }
