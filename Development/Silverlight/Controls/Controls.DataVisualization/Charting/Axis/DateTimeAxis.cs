...
namespace Microsoft.Windows.Controls.DataVisualization.Charting
{
    ...
    public sealed class DateTimeAxis : RangeAxis
    {
        ...
        /// </param>
        protected override void PrepareAxisLabel(ContentControl label, object dataContext)
        {
        ...
        protected override double GetPlotAreaCoordinate(IComparable value)
        {
            ...
            if (ActualRange.HasData)
            {
                ...
                return (dateTimeValue.ToOADate() - actualDateTimeRange.Minimum.ToOADate()) * (pixelLength / rangelength);
            }
        ...
        private IEnumerable<DateTime> GetMajorAxisValues()
        {
        ...
        {
            return GetMajorAxisValues().Cast<IComparable>();
        }
        ...
        protected override Range<IComparable> GetValueRangeAtPlotAreaCoordinate(double value)
        {
            if (ActualRange.HasData && ActualLength != 0.0)
            {
                ...
                DateTime output = DateTime.FromOADate((value * (rangelength / ActualLength)) + minimumAsDouble);
        ...
        private double CalculateDateTimeInterval(DateTime minimum, DateTime maximum, out DateTimeIntervalType type)
        {
            ...
            double rangeMultiplicator = ActualLength / (200 * 10 / maxIntervals);
