...
namespace Microsoft.Windows.Controls.DataVisualization.Charting
{
    ...
    public abstract class DynamicSingleSeriesWithAxes : DynamicSeriesWithAxes, IRequireGlobalSeriesIndex
    {
        /// <summary>
        ...
        public static readonly DependencyProperty DataPointStyleProperty =
            DependencyProperty.Register(
                "DataPointStyle",
                typeof(Style),
                typeof(DynamicSingleSeriesWithAxes),
                null);
        ...
        {
            DynamicSingleSeriesWithAxes source = (DynamicSingleSeriesWithAxes)d;
        ...
        /// </summary>
        internal DynamicSingleSeriesWithAxes()
        {
        }
