...
namespace Microsoft.Windows.Controls.DataVisualization
{
    ...
    internal static class DependencyPropertyAnimationHelper
    {
        ...
        public static void BeginAnimation(this FrameworkElement target, DependencyProperty animatingDependencyProperty, string propertyPath, object targetValue, TimeSpan timeSpan)
        {
            ...
            {
                storyBoard.Pause();
                object endValue = target.GetValue(animatingDependencyProperty);
                storyBoard.SkipToFill();
                storyBoard.Stop();
                target.Resources.Remove(GetStoryboardKey(propertyPath));
                target.SetValue(animatingDependencyProperty, endValue);
            }

            storyBoard = CreateStoryboard(target, animatingDependencyProperty, propertyPath, targetValue, timeSpan);
                ...
                (source, args) =>
                    {
                        ...
                        storyBoard.Stop();
                        target.SetValue(animatingDependencyProperty, endValue);
                        target.Resources.Remove(propertyPath);
                    };
        ...
        private static Storyboard CreateStoryboard(FrameworkElement target, DependencyProperty animatingDependencyProperty, string propertyPath, object toValue, TimeSpan durationTimeSpan)
        {
