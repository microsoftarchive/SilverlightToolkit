...
namespace Microsoft.Windows.Controls.Input.VisualStudio.Design
{
    /// <summary>
    ...
    public class MetadataRegistration : MetadataRegistrationBase, IRegisterMetadata
    {
        ...
        {
            builder.AddCallback(typeof(ButtonSpinner), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(false)));
        }
    }
}
