...
namespace Microsoft.Windows.Controls.Testing
{
    ...
    public partial class AutoCompleteBoxTest : ControlTest
    {
        ...
        public void TextCompletionViaTextProperty()
        {
            ...
            EnqueueCallback(() => Assert.IsNotNull(control.TextBox, "The TextBox part could not be retrieved."));
            EnqueueCallback(() => Assert.IsNull(control.Text));
        ...
        public void ItemSearch()
        {
            ...
            EnqueueCallback(() => control.ConverterParameter = "This is a parameter.");
            EnqueueCallback(() => control.ConverterCulture = CultureInfo.CurrentCulture);
            EnqueueCallback(() => Assert.IsNotNull(control.ItemsSource, "The ItemsSource property is null for some unknown reason."));
