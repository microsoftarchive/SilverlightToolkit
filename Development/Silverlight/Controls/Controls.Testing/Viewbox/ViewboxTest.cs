...
namespace Microsoft.Windows.Controls.Testing
{
    ...
    public partial class ViewboxTest : ControlTest
    {
        ...
        public virtual IEnumerable<Viewbox> ViewboxesToTest
        {
            get
            {
                ...
                string xmlChild = "<Grid " + xmlns + " Background=\"Yellow\" > " +
                    ...
                    "       <ColumnDefinition Width=\"*\" /> " +
                    "   </Grid.ColumnDefinitions> " +
                    "   <controls:Viewbox Stretch=\"None\" Background=\"Chocolate\" HorizontalContentAlignment=\"Center\" VerticalContentAlignment=\"Center\" > " +
                    "       <Rectangle Width=\"2000\" Height=\"10\" Stroke=\"Fuchsia\" StrokeThickness=\"2\" Fill=\"Violet\" Stretch=\"UniformToFill\"></Rectangle> " +
                    "   </controls:Viewbox> " +
                    "   <controls:Viewbox Grid.Column=\"1\" Stretch=\"Fill\"> " +
                    "       <ScrollViewer> " +
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            // Remove the tests requiring that set templates inherited from
            // properties on ControlTest (because Viewbox doesn't allow the
            // template to be redefined)
