...
{
    /// <summary>
    /// Bug regression tests for the Microsoft.Windows.Controls.DockPanel class.
    /// </summary>
    public partial class DockPanelTest
    {
        ...
        [Asynchronous]
        [Bug("528095 - DockPanel - Cannot be styled in XAML, e.g. setting background", Fixed = false)]
        public void StyleBackgroundInXaml()
        {
            ...
            {
                ExplicitNamespaces = new Dictionary<string, string> { { "controls", XamlBuilder.GetNamespace(typeof(DockPanel)) } },
                AttributeProperties = new Dictionary<string, string> { { "TargetType", "controls:DockPanel" } },
