...
{
    /// <summary>
    /// Bug regression tests for the Microsoft.Windows.Controls.Expander class.
    /// </summary>
    public partial class ExpanderTest
    {
        ...
        public void TestHorizontalAndVerticalContentAlignmentOfExpander()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual(exp.ActualWidth - tb.Width, pt.X),
                () => Assert.AreEqual(exp.ActualHeight - tb.Height, pt.Y));
        }
        ...
        public void TestContentFillSpaceOfExpander()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual(exp.ActualWidth, bn.ActualWidth),
