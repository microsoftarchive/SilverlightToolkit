...
namespace Microsoft.Windows.Controls.Testing
{
    ...
    public class ExpanderAutomationPeerTest : TestBase
    {
        ...
        [SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", MessageId = "Microsoft.Windows.Controls.Automation.Peers.ExpanderAutomationPeer", Justification = "Don't need to use it")]
