    ...
    public abstract class UpDownBaseTest : ControlTest
    {
            ...
            : base()
        {
            ...
            SpinnerStyleProperty = new DependencyPropertyTest<UpDownBase, Style>(this, "SpinnerStyle")
            {
                ...
                DefaultValue = null,
                OtherValues = new Style[] { new Style(typeof(UpDownBase)), new Style(typeof(Control)) }
            };
        }
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(SpinnerStyleProperty.ChangeClrSetterTest.Bug("Todo: figure out why this fails!"));
            tests.Add(SpinnerStyleProperty.ChangeSetValueTest.Bug("Todo: figure out why this fails!"));
            tests.Add(SpinnerStyleProperty.SetNullTest);
            tests.Add(SpinnerStyleProperty.ClearValueResetsDefaultTest.Bug("Todo: figure out why this fails!"));
            tests.Add(SpinnerStyleProperty.CanBeStyledTest.Bug("Todo: figure out why this fails!"));
            tests.Add(SpinnerStyleProperty.TemplateBindTest.Bug("Todo: figure out why this fails!"));
