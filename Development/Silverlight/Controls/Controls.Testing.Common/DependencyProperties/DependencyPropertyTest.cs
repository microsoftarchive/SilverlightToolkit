        ...
        where T : FrameworkElement
    {
        ...
        protected virtual void InvalidValueDoesNotChangeVisualState()
        {
            ...
            foreach (KeyValuePair<P, Type> pair in InvalidValues)
            {
                ...
                Test.TestTaskAsync(
                    ...
                    () =>
                    {
                        FrameworkElement root = instance.GetVisualChildren().FirstOrDefault() as FrameworkElement;
                    ...
                    () => Assert.AreEqual(0, vsm.ChangedStates.Count, "Changing the value to {1} changed the visual state!", pair.Key));
            }
        ...
        protected virtual void ChangesVisualState(P fromValue, P toValue, string newState)
        {
            ...
            Test.TestAsync(
                ...
                () =>
                {
                    FrameworkElement root = instance.GetVisualChildren().First() as FrameworkElement;
                    VisualStateManager.SetCustomVisualStateManager(root, vsm);
                },
