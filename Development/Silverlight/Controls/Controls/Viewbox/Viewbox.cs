...
namespace Microsoft.Windows.Controls
{
    ...
    public sealed partial class Viewbox : Control
    {
        /// <summary>
        ...
        private static void OnStretchPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!IsValidStretchValue(e.NewValue))
            {
                ...
                string message = string.Format(
                    ...
                    Properties.Resources.Viewbox_OnStretchPropertyChanged_InvalidValue,
                    e.NewValue);
        ...
        public override void OnApplyTemplate()
        {
            ...
            {
                throw new InvalidOperationException(Properties.Resources.Viewbox_OnApplyTemplate_OnlyOnce);
            }
