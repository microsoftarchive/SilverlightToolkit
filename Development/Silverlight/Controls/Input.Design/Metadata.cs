...
namespace Microsoft.Windows.Controls.Input.Design
{
    ...
    public class MetadataRegistration : MetadataRegistrationBase, IRegisterMetadata
    {
        ...
        public MetadataRegistration()
            : base()
        {
            AssemblyName asmName = typeof(NumericUpDown).Assembly.GetName();
        ...
        {
            ////builder.AddCallback(typeof(UpDownBase), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(false)));
        }
    }
}
