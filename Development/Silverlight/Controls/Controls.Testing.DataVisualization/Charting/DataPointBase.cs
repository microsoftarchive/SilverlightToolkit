    ...
    public abstract partial class DataPointBase : ControlTest
    {
        ...
        public void IndependentValueStringFormatChange()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual("0.12345", dataPoint.FormattedIndependentValue),
                () => dataPoint.IndependentValueStringFormat = "{0:0.##}",
                () => Assert.AreEqual("0.12", dataPoint.FormattedIndependentValue));
        }
        ...
        public void DependentValueStringFormatChange()
        {
            ...
            TestAsync(
                ...
                () => Assert.AreEqual("0.12345", dataPoint.FormattedDependentValue),
                () => dataPoint.DependentValueStringFormat = "{0:0.##}",
                () => Assert.AreEqual("0.12", dataPoint.FormattedDependentValue));
        }
