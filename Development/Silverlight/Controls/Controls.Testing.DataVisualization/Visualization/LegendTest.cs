...
namespace Microsoft.Windows.Controls.Testing
{
    ...
    public partial class LegendTest : ControlTest
    {
        ...
        public void InitialValues()
        {
            ...
            TestAsync(
                legend,
                () => Assert.IsNull(legend.LegendItems),
                () => Assert.IsNull(legend.Title),
        ...
        public void TitleChangeString()
        {
            ...
            legend.Title = title;
            Assert.AreSame(title, legend.Title);
        }
        ...
        /// <summary>
        /// Assigns an empty collection to the LegendItems property.
        /// </summary>
        [TestMethod]
        [Description("Assigns an empty collection to the LegendItems property.")]
        public void LegendItemsChangeEmpty()
        {
            Legend legend = new Legend();
            ObjectCollection objectCollection = new ObjectCollection();
            legend.LegendItems = objectCollection;
            Assert.AreSame(objectCollection, legend.LegendItems);
        }

        /// <summary>
        /// Assigns a collection of objects to the LegendItems property.
        /// </summary>
        [TestMethod]
        [Description("Assigns a collection of objects to the LegendItems property.")]
        public void LegendItemsChangeObjects()
        {
            Legend legend = new Legend();
            ObjectCollection objectCollection = new ObjectCollection();
        ...
        /// <summary>
        /// Assigns a collection of Series to the LegendItems property.
        /// </summary>
        [TestMethod]
        [Description("Assigns a collection of Series to the LegendItems property.")]
        public void LegendItemsChangeSeries()
        {
            Legend legend = new Legend();
            ObjectCollection objectCollection = new ObjectCollection();
            objectCollection.Add(new ColumnSeries());
            objectCollection.Add(new ColumnSeries());
            legend.LegendItems = objectCollection;
            Assert.AreSame(objectCollection, legend.LegendItems);
        }
        ...
        public void AutomaticVisibilitySwitching()
        {
            ...
            legend.LegendItems = new UIElement[] { };
            Assert.AreEqual(Visibility.Collapsed, legend.Visibility);
            ObservableCollection<UIElement> collection1 = new ObservableCollection<UIElement>();
            legend.LegendItems = collection1;
            Assert.AreEqual(Visibility.Collapsed, legend.Visibility);
            legend.LegendItems = null;
            Assert.AreEqual(Visibility.Collapsed, legend.Visibility);
            ObservableCollection<UIElement> collection = new ObservableCollection<UIElement>();
            legend.LegendItems = collection;
            Assert.AreEqual(Visibility.Collapsed, legend.Visibility);
            Button button0 = new Button();
            collection.Add(button0);
            Assert.AreEqual(Visibility.Visible, legend.Visibility);
            Button button1 = new Button();
            collection.Add(button1);
            Assert.AreEqual(Visibility.Visible, legend.Visibility);
        ...
        public override void TemplatePartsAreDefined()
        {
            ...
            Assert.AreSame(typeof(Panel), templateParts["LegendItemsArea"]);
        }
    }
}