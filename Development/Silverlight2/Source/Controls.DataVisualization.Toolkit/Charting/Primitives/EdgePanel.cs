...
namespace System.Windows.Controls.DataVisualization.Charting.Primitives
{
    ...
    public class EdgePanel : Panel
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            Rect totalRect = new Rect(0, 0, constraint.Width, constraint.Height);
            ...
            while (true)
            {
                ...
                {
                    _leftRect = new Rect(0, maxTopRequestedHeight, maxLeftRequestedWidth, (constraint.Height - maxTopRequestedHeight) - maxBottomRequestedHeight);
                    _rightRect = new Rect(constraint.Width - maxRightRequestedWidth, maxTopRequestedHeight, maxRightRequestedWidth, (constraint.Height - maxTopRequestedHeight) - maxBottomRequestedHeight);
                    _bottomRect = new Rect(maxLeftRequestedWidth, constraint.Height - maxBottomRequestedHeight, (constraint.Width - maxLeftRequestedWidth) - maxRightRequestedWidth, maxBottomRequestedHeight);
                    _topRect = new Rect(maxLeftRequestedWidth, 0, (constraint.Width - maxLeftRequestedWidth) - maxRightRequestedWidth, maxTopRequestedHeight);
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            if (!_bottomRect.IsEmpty)
            {
                ...
                foreach (UIElement bottomUIElement in bottomElements)
                {
                    bottomUIElement.Arrange(new Rect(_leftRect.RightOrDefault(0), workingHeight, (arrangeSize.Width - _leftRect.WidthOrDefault(0)) - _rightRect.WidthOrDefault(0), bottomUIElement.DesiredSize.Height));
            ...
            if (!_topRect.IsEmpty)
            {
                ...
                foreach (UIElement topUIElement in topElements)
                {
                    ...
                    topUIElement.Arrange(new Rect(_leftRect.RightOrDefault(0), workingTop, (arrangeSize.Width - _leftRect.WidthOrDefault(0)) - _rightRect.WidthOrDefault(0), topUIElement.DesiredSize.Height));
                }
            }
            ...
            if (!_rightRect.IsEmpty)
            {
                ...
                foreach (UIElement rightUIElement in rightElements)
                {
                    rightUIElement.Arrange(new Rect(workingRight, _topRect.BottomOrDefault(0), rightUIElement.DesiredSize.Width, (arrangeSize.Height - _bottomRect.HeightOrDefault(0)) - _topRect.HeightOrDefault(0)));
            ...
            if (!_leftRect.IsEmpty)
            {
                ...
                foreach (UIElement leftUIElement in leftElements)
                {
                    ...
                    Rect leftRect = new Rect(workingLeft, _topRect.BottomOrDefault(0), leftUIElement.DesiredSize.Width, (arrangeSize.Height - _bottomRect.HeightOrDefault(0)) - _topRect.HeightOrDefault(0));
