...
namespace System.Windows.Controls.Testing
{
    ...
    public class ListTimePickerPopupTest : TimePickerPopupBaseTest
    {
        ...
        public override IEnumerable<DependencyPropertyTestMethod> GetDependencyPropertyTests()
        {
            ...
            tests.Add(ListBoxStyleProperty.ChangeClrSetterTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxStyleProperty.ChangeSetValueTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxStyleProperty.SetNullTest);
            tests.Add(ListBoxStyleProperty.ClearValueResetsDefaultTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxStyleProperty.CanBeStyledTest);
            tests.Add(ListBoxStyleProperty.TemplateBindTest.Bug("Style with templatebinding throws catastrophic error"));
            ...
            tests.Add(ListBoxItemStyleProperty.ChangeClrSetterTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxItemStyleProperty.ChangeSetValueTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxItemStyleProperty.SetNullTest);
            tests.Add(ListBoxItemStyleProperty.ClearValueResetsDefaultTest.Bug("Style with templatebinding throws catastrophic error"));
            tests.Add(ListBoxItemStyleProperty.CanBeStyledTest);
            tests.Add(ListBoxItemStyleProperty.TemplateBindTest.Bug("Style with templatebinding throws catastrophic error"));
