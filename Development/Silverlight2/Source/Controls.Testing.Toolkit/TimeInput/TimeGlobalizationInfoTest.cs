...
namespace System.Windows.Controls.Testing
{
    ...
    public class TimeGlobalizationInfoTest : TestBase
    {
        ...
        public virtual void ShouldDetermineTimeUnitAtPositionsInString()
        {
            ...
            Assert.AreEqual(TimeSpan.FromHours(10), strategy.GetTimeUnitAtTextPosition(date, 0, military));
        ...
        public virtual void ShouldDetermineTextPositionInDateTime()
        {
            ...
            Assert.AreEqual(0, strategy.GetTextPositionForTimeUnit(date, TimeSpan.FromHours(10), military));
            Assert.AreEqual(1, strategy.GetTextPositionForTimeUnit(date, TimeSpan.FromHours(1), military));
        ...
        public virtual void ShouldMapGlobalCharacters()
        {
            ...
            {
                Thread.CurrentThread.CurrentCulture = new CultureInfo("nl-NL");
                string formatted = strategy.FormatTime(new DateTime(1900, 1, 1, 5, 6, 7), new LongTimeFormat());
                Assert.AreEqual("٥:٠٦:٠٧", formatted);

                DateTime? result;
                Assert.IsTrue(strategy.TryParseTime("٥:٠٦:٠٧", new LongTimeFormat(), null, out result));
        ...
        public virtual void ShouldHandleArabicCulture()
        {
            ...
            try
            {
                ...
                string formatted = strategy.FormatTime(new DateTime(1900, 1, 1, 14, 2, 0), new ShortTimeFormat());
                Assert.AreEqual("٠٢:٠٢ م", formatted);

                DateTime? result;
                Assert.IsTrue(strategy.TryParseTime("٠٢:٠٢ م", new ShortTimeFormat(), null, out result));
