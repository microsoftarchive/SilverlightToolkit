...
namespace System.Windows.Controls.Testing
{
    ...
    public class ExpandableContentControlTest : ContentControlTest
    {
        ...
        public override void TemplatePartsAreDefined()
        {
            ...
            Assert.AreEqual(typeof(ScrollViewer), parts["ScrollSite"], "Failed to find expected part ScrollSite!");
            Assert.AreEqual(typeof(ContentControl), parts["ContentSite"], "Failed to find expected part ContentSite!");
        }
